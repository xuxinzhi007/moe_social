...
class ApiService {
  ...
  // 生产环境地址（cpolar隧道）
  static const String _productionUrl = 'http://2370922e.r3.cpolar.top';
  ...
  static String get baseUrl {
    ...
    if (kIsWeb) {
      ...
      // return 'http://2370922e.r3.cpolar.top'; // 使用生产环境
      // 或者使用电脑IP（需要根据实际情况修改）
      // return 'http://192.168.1.16:8888'; // 替换为你的电脑IP
      return 'http://2370922e.r3.cpolar.top'; // Android模拟器使用这个
