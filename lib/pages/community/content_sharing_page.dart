...
class _ContentSharingPageState extends State<ContentSharingPage> {
  List<SharedContent> _contents = [
    ...
    SharedContent(
      ...
      authorName: '学习达人',
      authorAvatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cartoon%20avatar%20of%20a%20student%20with%20books&image_size=square',
      likeCount: 156,
      commentCount: 32,
      shareCount: 8,
    ...
    SharedContent(
      ...
      authorName: '美食博主',
      authorAvatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cartoon%20avatar%20of%20a%20chef&image_size=square',
      likeCount: 345,
      commentCount: 67,
      shareCount: 23,
    ...
    SharedContent(
      ...
      type: 'image',
      title: '旅行中的意外发现',
      imageUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=hidden%20gem%20travel%20spot%20with%20beautiful%20scenery&image_size=landscape_16_9',
      content: '在旅行中偶然发现的一个小众景点，人少景美，推荐给喜欢旅行的朋友！',
      authorName: '旅行爱好者',
      authorAvatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cartoon%20avatar%20of%20a%20traveler&image_size=square',
      likeCount: 189,
      commentCount: 28,
      shareCount: 15,
