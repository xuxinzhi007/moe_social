...
class _InterestGroupsPageState extends State<InterestGroupsPage> {
  List<InterestGroup> _groups = [
    ...
    InterestGroup(
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=food%20sharing%20group%20cover%20with%20delicious%20dishes&image_size=landscape_16_9',
      memberCount: 2341,
      postCount: 5678,
      isJoined: false,
      tags: ['美食', '烹饪', '餐厅'],
    ...
    InterestGroup(
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=travel%20diary%20group%20cover%20with%20world%20map%20and%20landmarks&image_size=landscape_16_9',
      memberCount: 1890,
      postCount: 4321,
      isJoined: false,
      tags: ['旅行', '攻略', '分享'],
    ...
    InterestGroup(
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=book%20club%20group%20cover%20with%20books%20and%20reading%20nook&image_size=landscape_16_9',
      memberCount: 987,
      postCount: 2345,
      isJoined: true,
      tags: ['读书', '文学', '讨论'],
    ...
    InterestGroup(
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=fitness%20group%20cover%20with%20gym%20equipment%20and%20active%20people&image_size=landscape_16_9',
      memberCount: 1567,
      postCount: 3456,
      isJoined: false,
      tags: ['健身', '运动', '健康'],
