...
type CompanionProfile struct {
	...
	ProactiveEnabled        bool      `gorm:"not null;default:true" json:"proactive_enabled"`
	ProactiveDailyLimit     int       `gorm:"not null;default:1" json:"proactive_daily_limit"`
	ProactiveQuietStart     int       `gorm:"not null;default:1350" json:"proactive_quiet_start"`
	ProactiveQuietEnd       int       `gorm:"not null;default:450" json:"proactive_quiet_end"`
	ProactiveTimezoneOffset int       `gorm:"not null;default:0" json:"proactive_timezone_offset"`
