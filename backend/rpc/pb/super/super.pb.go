...
const file_super_proto_rawDesc = "" +
	...
	"created_at\x18\x06 \x01(\tR\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\a \x01(\tR\tupdatedAt\"\x99\x02\n" +
	"\n" +
	"GiftRecord\x12\x0e\n" +
	...
	"\x0eGetGiftRecords\x12\x18.super.GetGiftRecordsReq\x1a\x19.super.GetGiftRecordsRespB\x16Z\x14backend/rpc/pb/superb\x06proto3"
...
var file_super_proto_msgTypes = make([]protoimpl.MessageInfo, 169)
var file_super_proto_goTypes = []any{
	...
	(*Group)(nil),                          // 139: super.Group
	(*GroupMember)(nil),                    // 140: super.GroupMember
	(*CreateGroupReq)(nil),                 // 141: super.CreateGroupReq
	(*CreateGroupResp)(nil),                // 142: super.CreateGroupResp
	(*GetGroupReq)(nil),                    // 143: super.GetGroupReq
	(*GetGroupResp)(nil),                   // 144: super.GetGroupResp
	(*GetGroupsReq)(nil),                   // 145: super.GetGroupsReq
	(*GetGroupsResp)(nil),                  // 146: super.GetGroupsResp
	(*UpdateGroupReq)(nil),                 // 147: super.UpdateGroupReq
	(*UpdateGroupResp)(nil),                // 148: super.UpdateGroupResp
	(*DeleteGroupReq)(nil),                 // 149: super.DeleteGroupReq
	(*DeleteGroupResp)(nil),                // 150: super.DeleteGroupResp
	(*JoinGroupReq)(nil),                   // 151: super.JoinGroupReq
	(*JoinGroupResp)(nil),                  // 152: super.JoinGroupResp
	(*LeaveGroupReq)(nil),                  // 153: super.LeaveGroupReq
	(*LeaveGroupResp)(nil),                 // 154: super.LeaveGroupResp
	(*GetGroupMembersReq)(nil),             // 155: super.GetGroupMembersReq
	(*GetGroupMembersResp)(nil),            // 156: super.GetGroupMembersResp
	(*GetUserGroupsReq)(nil),               // 157: super.GetUserGroupsReq
	(*GetUserGroupsResp)(nil),              // 158: super.GetUserGroupsResp
	(*Gift)(nil),                           // 159: super.Gift
	(*GiftRecord)(nil),                     // 160: super.GiftRecord
	(*GetGiftsReq)(nil),                    // 161: super.GetGiftsReq
	(*GetGiftsResp)(nil),                   // 162: super.GetGiftsResp
	(*GetGiftReq)(nil),                     // 163: super.GetGiftReq
	(*GetGiftResp)(nil),                    // 164: super.GetGiftResp
	(*SendGiftReq)(nil),                    // 165: super.SendGiftReq
	(*SendGiftResp)(nil),                   // 166: super.SendGiftResp
	(*GetGiftRecordsReq)(nil),              // 167: super.GetGiftRecordsReq
...
var file_super_proto_depIdxs = []int32{
	...
	139, // 48: super.CreateGroupResp.group:type_name -> super.Group
	139, // 49: super.GetGroupResp.group:type_name -> super.Group
	139, // 50: super.GetGroupsResp.groups:type_name -> super.Group
	139, // 51: super.UpdateGroupResp.group:type_name -> super.Group
	140, // 52: super.GetGroupMembersResp.members:type_name -> super.GroupMember
	139, // 53: super.GetUserGroupsResp.groups:type_name -> super.Group
	159, // 54: super.GiftRecord.gift:type_name -> super.Gift
	159, // 55: super.GetGiftsResp.gifts:type_name -> super.Gift
	...
	2,   // 133: super.Super.Register:output_type -> super.RegisterResp
	4,   // 134: super.Super.Login:output_type -> super.LoginResp
	6,   // 135: super.Super.GetUserInfo:output_type -> super.GetUserInfoResp
	8,   // 136: super.Super.GetUser:output_type -> super.GetUserResp
	10,  // 137: super.Super.GetUserByEmail:output_type -> super.GetUserByEmailResp
	12,  // 138: super.Super.UpdateUserInfo:output_type -> super.UpdateUserInfoResp
	14,  // 139: super.Super.UpdateUserPassword:output_type -> super.UpdateUserPasswordResp
	16,  // 140: super.Super.ResetPassword:output_type -> super.ResetPasswordResp
	18,  // 141: super.Super.DeleteUser:output_type -> super.DeleteUserResp
	20,  // 142: super.Super.UpdateUserVip:output_type -> super.UpdateUserVipResp
	22,  // 143: super.Super.GetUsers:output_type -> super.GetUsersResp
	24,  // 144: super.Super.GetUserCount:output_type -> super.GetUserCountResp
	89,  // 145: super.Super.UpsertUserMemory:output_type -> super.UpsertUserMemoryResp
	91,  // 146: super.Super.GetUserMemories:output_type -> super.GetUserMemoriesResp
	93,  // 147: super.Super.DeleteUserMemory:output_type -> super.DeleteUserMemoryResp
	31,  // 148: super.Super.GetVipPlans:output_type -> super.GetVipPlansResp
	27,  // 149: super.Super.GetVipPlan:output_type -> super.GetVipPlanResp
	29,  // 150: super.Super.CreateVipPlan:output_type -> super.CreateVipPlanResp
	34,  // 151: super.Super.CreateVipOrder:output_type -> super.CreateVipOrderResp
	36,  // 152: super.Super.GetVipOrders:output_type -> super.GetVipOrdersResp
	39,  // 153: super.Super.GetVipRecords:output_type -> super.GetVipRecordsResp
	41,  // 154: super.Super.GetUserActiveVipRecord:output_type -> super.GetUserActiveVipRecordResp
	43,  // 155: super.Super.GetUserVipStatus:output_type -> super.GetUserVipStatusResp
	45,  // 156: super.Super.CheckUserVip:output_type -> super.CheckUserVipResp
	47,  // 157: super.Super.UpdateAutoRenew:output_type -> super.UpdateAutoRenewResp
	49,  // 158: super.Super.SyncUserVipStatus:output_type -> super.SyncUserVipStatusResp
	60,  // 159: super.Super.GetPosts:output_type -> super.GetPostsResp
	62,  // 160: super.Super.GetPost:output_type -> super.GetPostResp
	66,  // 161: super.Super.CreatePost:output_type -> super.CreatePostResp
	65,  // 162: super.Super.ReportPost:output_type -> super.ReportPostResp
	68,  // 163: super.Super.LikePost:output_type -> super.LikePostResp
	70,  // 164: super.Super.GetPostComments:output_type -> super.GetPostCommentsResp
	73,  // 165: super.Super.CreateComment:output_type -> super.CreateCommentResp
	75,  // 166: super.Super.LikeComment:output_type -> super.LikeCommentResp
	78,  // 167: super.Super.GetNotifications:output_type -> super.GetNotificationsResp
	80,  // 168: super.Super.GetUnreadCount:output_type -> super.GetUnreadCountResp
	82,  // 169: super.Super.ReadNotification:output_type -> super.ReadNotificationResp
	84,  // 170: super.Super.ReadAllNotifications:output_type -> super.ReadAllNotificationsResp
	86,  // 171: super.Super.CreateNotification:output_type -> super.CreateNotificationResp
	51,  // 172: super.Super.Recharge:output_type -> super.RechargeResp
	54,  // 173: super.Super.GetTransactions:output_type -> super.GetTransactionsResp
	56,  // 174: super.Super.GetTransaction:output_type -> super.GetTransactionResp
	110, // 175: super.Super.FollowUser:output_type -> super.FollowUserResp
	110, // 176: super.Super.UnfollowUser:output_type -> super.FollowUserResp
	113, // 177: super.Super.GetFollowings:output_type -> super.GetFollowingsResp
	115, // 178: super.Super.GetFollowers:output_type -> super.GetFollowersResp
	117, // 179: super.Super.CheckFollow:output_type -> super.CheckFollowResp
	96,  // 180: super.Super.SendFriendRequest:output_type -> super.SendFriendRequestResp
	98,  // 181: super.Super.ListIncomingFriendRequests:output_type -> super.ListIncomingFriendRequestsResp
	100, // 182: super.Super.ListOutgoingFriendRequests:output_type -> super.ListOutgoingFriendRequestsResp
	102, // 183: super.Super.AcceptFriendRequest:output_type -> super.AcceptFriendRequestResp
	104, // 184: super.Super.RejectFriendRequest:output_type -> super.RejectFriendRequestResp
	106, // 185: super.Super.ListFriends:output_type -> super.ListFriendsResp
	108, // 186: super.Super.GetFriendRelation:output_type -> super.GetFriendRelationResp
	122, // 187: super.Super.GetUserAvatar:output_type -> super.GetUserAvatarResp
	124, // 188: super.Super.UpdateUserAvatar:output_type -> super.UpdateUserAvatarResp
	130, // 189: super.Super.CheckIn:output_type -> super.CheckInResp
	132, // 190: super.Super.GetUserLevel:output_type -> super.GetUserLevelResp
	134, // 191: super.Super.GetCheckInStatus:output_type -> super.GetCheckInStatusResp
	136, // 192: super.Super.GetCheckInHistory:output_type -> super.GetCheckInHistoryResp
	138, // 193: super.Super.GetExpLogs:output_type -> super.GetExpLogsResp
	142, // 194: super.Super.CreateGroup:output_type -> super.CreateGroupResp
	144, // 195: super.Super.GetGroup:output_type -> super.GetGroupResp
	146, // 196: super.Super.GetGroups:output_type -> super.GetGroupsResp
	148, // 197: super.Super.UpdateGroup:output_type -> super.UpdateGroupResp
	150, // 198: super.Super.DeleteGroup:output_type -> super.DeleteGroupResp
	152, // 199: super.Super.JoinGroup:output_type -> super.JoinGroupResp
	154, // 200: super.Super.LeaveGroup:output_type -> super.LeaveGroupResp
	156, // 201: super.Super.GetGroupMembers:output_type -> super.GetGroupMembersResp
	158, // 202: super.Super.GetUserGroups:output_type -> super.GetUserGroupsResp
	162, // 203: super.Super.GetGifts:output_type -> super.GetGiftsResp
	164, // 204: super.Super.GetGift:output_type -> super.GetGiftResp
	166, // 205: super.Super.SendGift:output_type -> super.SendGiftResp
	168, // 206: super.Super.GetGiftRecords:output_type -> super.GetGiftRecordsResp
