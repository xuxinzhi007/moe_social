...
const file_super_proto_rawDesc = "" +
	...
	"\x05color\x18\x03 \x01(\tR\x05color\"\xbb\x02\n" +
	"\x04Post\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	...
	"\x04post\x18\x01 \x01(\v2\v.super.PostR\x04post\"\x8a\x01\n" +
	"\rCreatePostReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12\x16\n" +
	"\x06images\x18\x03 \x03(\tR\x06images\x12.\n" +
	"\n" +
	"topic_tags\x18\x04 \x03(\v2\x0f.super.TopicTagR\ttopicTags\"1\n" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total2\xd5 \n" +
	"\x05Super\x123\n" +
...
var file_super_proto_msgTypes = make([]protoimpl.MessageInfo, 137)
var file_super_proto_goTypes = []any{
	...
	(*FriendRequestView)(nil),              // 92: super.FriendRequestView
	(*SendFriendRequestReq)(nil),           // 93: super.SendFriendRequestReq
	(*SendFriendRequestResp)(nil),          // 94: super.SendFriendRequestResp
	(*ListIncomingFriendRequestsReq)(nil),  // 95: super.ListIncomingFriendRequestsReq
	(*ListIncomingFriendRequestsResp)(nil), // 96: super.ListIncomingFriendRequestsResp
	(*ListOutgoingFriendRequestsReq)(nil),  // 97: super.ListOutgoingFriendRequestsReq
	(*ListOutgoingFriendRequestsResp)(nil), // 98: super.ListOutgoingFriendRequestsResp
	(*AcceptFriendRequestReq)(nil),         // 99: super.AcceptFriendRequestReq
	(*AcceptFriendRequestResp)(nil),        // 100: super.AcceptFriendRequestResp
	(*RejectFriendRequestReq)(nil),         // 101: super.RejectFriendRequestReq
	(*RejectFriendRequestResp)(nil),        // 102: super.RejectFriendRequestResp
	(*ListFriendsReq)(nil),                 // 103: super.ListFriendsReq
	(*ListFriendsResp)(nil),                // 104: super.ListFriendsResp
	(*GetFriendRelationReq)(nil),           // 105: super.GetFriendRelationReq
	(*GetFriendRelationResp)(nil),          // 106: super.GetFriendRelationResp
	(*FollowUserReq)(nil),                  // 107: super.FollowUserReq
	(*FollowUserResp)(nil),                 // 108: super.FollowUserResp
	(*UnfollowUserReq)(nil),                // 109: super.UnfollowUserReq
	(*GetFollowingsReq)(nil),               // 110: super.GetFollowingsReq
	(*GetFollowingsResp)(nil),              // 111: super.GetFollowingsResp
	(*GetFollowersReq)(nil),                // 112: super.GetFollowersReq
	(*GetFollowersResp)(nil),               // 113: super.GetFollowersResp
	(*CheckFollowReq)(nil),                 // 114: super.CheckFollowReq
	(*CheckFollowResp)(nil),                // 115: super.CheckFollowResp
	(*AvatarBaseConfig)(nil),               // 116: super.AvatarBaseConfig
	(*AvatarOutfitConfig)(nil),             // 117: super.AvatarOutfitConfig
	(*UserAvatarData)(nil),                 // 118: super.UserAvatarData
	(*GetUserAvatarReq)(nil),               // 119: super.GetUserAvatarReq
	(*GetUserAvatarResp)(nil),              // 120: super.GetUserAvatarResp
	(*UpdateUserAvatarReq)(nil),            // 121: super.UpdateUserAvatarReq
	(*UpdateUserAvatarResp)(nil),           // 122: super.UpdateUserAvatarResp
	(*UserLevelInfo)(nil),                  // 123: super.UserLevelInfo
	(*CheckInStatus)(nil),                  // 124: super.CheckInStatus
	(*CheckInRecord)(nil),                  // 125: super.CheckInRecord
	(*ExpLogRecord)(nil),                   // 126: super.ExpLogRecord
	(*CheckInReq)(nil),                     // 127: super.CheckInReq
	(*CheckInResp)(nil),                    // 128: super.CheckInResp
	(*GetUserLevelReq)(nil),                // 129: super.GetUserLevelReq
	(*GetUserLevelResp)(nil),               // 130: super.GetUserLevelResp
	(*GetCheckInStatusReq)(nil),            // 131: super.GetCheckInStatusReq
	(*GetCheckInStatusResp)(nil),           // 132: super.GetCheckInStatusResp
	(*GetCheckInHistoryReq)(nil),           // 133: super.GetCheckInHistoryReq
	(*GetCheckInHistoryResp)(nil),          // 134: super.GetCheckInHistoryResp
	(*GetExpLogsReq)(nil),                  // 135: super.GetExpLogsReq
	(*GetExpLogsResp)(nil),                 // 136: super.GetExpLogsResp
}
var file_super_proto_depIdxs = []int32{
	...
	92,  // 32: super.SendFriendRequestResp.data:type_name -> super.FriendRequestView
	92,  // 33: super.ListIncomingFriendRequestsResp.data:type_name -> super.FriendRequestView
	92,  // 34: super.ListOutgoingFriendRequestsResp.data:type_name -> super.FriendRequestView
	...
	116, // 38: super.UserAvatarData.base_config:type_name -> super.AvatarBaseConfig
	117, // 39: super.UserAvatarData.current_outfit:type_name -> super.AvatarOutfitConfig
	118, // 40: super.GetUserAvatarResp.avatar:type_name -> super.UserAvatarData
	116, // 41: super.UpdateUserAvatarReq.base_config:type_name -> super.AvatarBaseConfig
	117, // 42: super.UpdateUserAvatarReq.current_outfit:type_name -> super.AvatarOutfitConfig
	118, // 43: super.UpdateUserAvatarResp.avatar:type_name -> super.UserAvatarData
	123, // 44: super.GetUserLevelResp.level_info:type_name -> super.UserLevelInfo
	124, // 45: super.GetCheckInStatusResp.status:type_name -> super.CheckInStatus
	125, // 46: super.GetCheckInHistoryResp.records:type_name -> super.CheckInRecord
	126, // 47: super.GetExpLogsResp.logs:type_name -> super.ExpLogRecord
	...
	86,  // 60: super.Super.UpsertUserMemory:input_type -> super.UpsertUserMemoryReq
	88,  // 61: super.Super.GetUserMemories:input_type -> super.GetUserMemoriesReq
	90,  // 62: super.Super.DeleteUserMemory:input_type -> super.DeleteUserMemoryReq
	...
	65,  // 77: super.Super.LikePost:input_type -> super.LikePostReq
	67,  // 78: super.Super.GetPostComments:input_type -> super.GetPostCommentsReq
	70,  // 79: super.Super.CreateComment:input_type -> super.CreateCommentReq
	72,  // 80: super.Super.LikeComment:input_type -> super.LikeCommentReq
	75,  // 81: super.Super.GetNotifications:input_type -> super.GetNotificationsReq
	77,  // 82: super.Super.GetUnreadCount:input_type -> super.GetUnreadCountReq
	79,  // 83: super.Super.ReadNotification:input_type -> super.ReadNotificationReq
	81,  // 84: super.Super.ReadAllNotifications:input_type -> super.ReadAllNotificationsReq
	83,  // 85: super.Super.CreateNotification:input_type -> super.CreateNotificationReq
	50,  // 86: super.Super.Recharge:input_type -> super.RechargeReq
	52,  // 87: super.Super.GetTransactions:input_type -> super.GetTransactionsReq
	55,  // 88: super.Super.GetTransaction:input_type -> super.GetTransactionReq
	107, // 89: super.Super.FollowUser:input_type -> super.FollowUserReq
	109, // 90: super.Super.UnfollowUser:input_type -> super.UnfollowUserReq
	110, // 91: super.Super.GetFollowings:input_type -> super.GetFollowingsReq
	112, // 92: super.Super.GetFollowers:input_type -> super.GetFollowersReq
	114, // 93: super.Super.CheckFollow:input_type -> super.CheckFollowReq
	93,  // 94: super.Super.SendFriendRequest:input_type -> super.SendFriendRequestReq
	95,  // 95: super.Super.ListIncomingFriendRequests:input_type -> super.ListIncomingFriendRequestsReq
	97,  // 96: super.Super.ListOutgoingFriendRequests:input_type -> super.ListOutgoingFriendRequestsReq
	99,  // 97: super.Super.AcceptFriendRequest:input_type -> super.AcceptFriendRequestReq
	101, // 98: super.Super.RejectFriendRequest:input_type -> super.RejectFriendRequestReq
	103, // 99: super.Super.ListFriends:input_type -> super.ListFriendsReq
	105, // 100: super.Super.GetFriendRelation:input_type -> super.GetFriendRelationReq
	119, // 101: super.Super.GetUserAvatar:input_type -> super.GetUserAvatarReq
	121, // 102: super.Super.UpdateUserAvatar:input_type -> super.UpdateUserAvatarReq
	127, // 103: super.Super.CheckIn:input_type -> super.CheckInReq
	129, // 104: super.Super.GetUserLevel:input_type -> super.GetUserLevelReq
	131, // 105: super.Super.GetCheckInStatus:input_type -> super.GetCheckInStatusReq
	133, // 106: super.Super.GetCheckInHistory:input_type -> super.GetCheckInHistoryReq
	135, // 107: super.Super.GetExpLogs:input_type -> super.GetExpLogsReq
	2,   // 108: super.Super.Register:output_type -> super.RegisterResp
	4,   // 109: super.Super.Login:output_type -> super.LoginResp
	6,   // 110: super.Super.GetUserInfo:output_type -> super.GetUserInfoResp
	8,   // 111: super.Super.GetUser:output_type -> super.GetUserResp
	10,  // 112: super.Super.GetUserByEmail:output_type -> super.GetUserByEmailResp
	12,  // 113: super.Super.UpdateUserInfo:output_type -> super.UpdateUserInfoResp
	14,  // 114: super.Super.UpdateUserPassword:output_type -> super.UpdateUserPasswordResp
	16,  // 115: super.Super.ResetPassword:output_type -> super.ResetPasswordResp
	18,  // 116: super.Super.DeleteUser:output_type -> super.DeleteUserResp
	20,  // 117: super.Super.UpdateUserVip:output_type -> super.UpdateUserVipResp
	22,  // 118: super.Super.GetUsers:output_type -> super.GetUsersResp
	24,  // 119: super.Super.GetUserCount:output_type -> super.GetUserCountResp
	87,  // 120: super.Super.UpsertUserMemory:output_type -> super.UpsertUserMemoryResp
	89,  // 121: super.Super.GetUserMemories:output_type -> super.GetUserMemoriesResp
	91,  // 122: super.Super.DeleteUserMemory:output_type -> super.DeleteUserMemoryResp
	31,  // 123: super.Super.GetVipPlans:output_type -> super.GetVipPlansResp
	27,  // 124: super.Super.GetVipPlan:output_type -> super.GetVipPlanResp
	29,  // 125: super.Super.CreateVipPlan:output_type -> super.CreateVipPlanResp
	34,  // 126: super.Super.CreateVipOrder:output_type -> super.CreateVipOrderResp
	36,  // 127: super.Super.GetVipOrders:output_type -> super.GetVipOrdersResp
	39,  // 128: super.Super.GetVipRecords:output_type -> super.GetVipRecordsResp
	41,  // 129: super.Super.GetUserActiveVipRecord:output_type -> super.GetUserActiveVipRecordResp
	43,  // 130: super.Super.GetUserVipStatus:output_type -> super.GetUserVipStatusResp
	45,  // 131: super.Super.CheckUserVip:output_type -> super.CheckUserVipResp
	47,  // 132: super.Super.UpdateAutoRenew:output_type -> super.UpdateAutoRenewResp
	49,  // 133: super.Super.SyncUserVipStatus:output_type -> super.SyncUserVipStatusResp
	60,  // 134: super.Super.GetPosts:output_type -> super.GetPostsResp
	62,  // 135: super.Super.GetPost:output_type -> super.GetPostResp
	64,  // 136: super.Super.CreatePost:output_type -> super.CreatePostResp
	66,  // 137: super.Super.LikePost:output_type -> super.LikePostResp
	68,  // 138: super.Super.GetPostComments:output_type -> super.GetPostCommentsResp
	71,  // 139: super.Super.CreateComment:output_type -> super.CreateCommentResp
	73,  // 140: super.Super.LikeComment:output_type -> super.LikeCommentResp
	76,  // 141: super.Super.GetNotifications:output_type -> super.GetNotificationsResp
	78,  // 142: super.Super.GetUnreadCount:output_type -> super.GetUnreadCountResp
	80,  // 143: super.Super.ReadNotification:output_type -> super.ReadNotificationResp
	82,  // 144: super.Super.ReadAllNotifications:output_type -> super.ReadAllNotificationsResp
	84,  // 145: super.Super.CreateNotification:output_type -> super.CreateNotificationResp
	51,  // 146: super.Super.Recharge:output_type -> super.RechargeResp
	54,  // 147: super.Super.GetTransactions:output_type -> super.GetTransactionsResp
	56,  // 148: super.Super.GetTransaction:output_type -> super.GetTransactionResp
	108, // 149: super.Super.FollowUser:output_type -> super.FollowUserResp
	108, // 150: super.Super.UnfollowUser:output_type -> super.FollowUserResp
	111, // 151: super.Super.GetFollowings:output_type -> super.GetFollowingsResp
	113, // 152: super.Super.GetFollowers:output_type -> super.GetFollowersResp
	115, // 153: super.Super.CheckFollow:output_type -> super.CheckFollowResp
	94,  // 154: super.Super.SendFriendRequest:output_type -> super.SendFriendRequestResp
	96,  // 155: super.Super.ListIncomingFriendRequests:output_type -> super.ListIncomingFriendRequestsResp
	98,  // 156: super.Super.ListOutgoingFriendRequests:output_type -> super.ListOutgoingFriendRequestsResp
	100, // 157: super.Super.AcceptFriendRequest:output_type -> super.AcceptFriendRequestResp
	102, // 158: super.Super.RejectFriendRequest:output_type -> super.RejectFriendRequestResp
	104, // 159: super.Super.ListFriends:output_type -> super.ListFriendsResp
	106, // 160: super.Super.GetFriendRelation:output_type -> super.GetFriendRelationResp
	120, // 161: super.Super.GetUserAvatar:output_type -> super.GetUserAvatarResp
	122, // 162: super.Super.UpdateUserAvatar:output_type -> super.UpdateUserAvatarResp
	128, // 163: super.Super.CheckIn:output_type -> super.CheckInResp
	130, // 164: super.Super.GetUserLevel:output_type -> super.GetUserLevelResp
	132, // 165: super.Super.GetCheckInStatus:output_type -> super.GetCheckInStatusResp
	134, // 166: super.Super.GetCheckInHistory:output_type -> super.GetCheckInHistoryResp
	136, // 167: super.Super.GetExpLogs:output_type -> super.GetExpLogsResp
