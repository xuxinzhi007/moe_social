...
// CreateGroup 创建群组。
func CreateGroup(ctx context.Context, db *gorm.DB, in *moe.CreateGroupReq) (*moe.CreateGroupResp, error) {
	if db == nil {
...
// JoinGroup 加入群组。
func JoinGroup(ctx context.Context, db *gorm.DB, in *moe.JoinGroupReq) (*moe.JoinGroupResp, error) {
	if db == nil {
		return nil, gorm.ErrInvalidDB
	}
...
// LeaveGroup 退出群组。
func LeaveGroup(ctx context.Context, db *gorm.DB, in *moe.LeaveGroupReq) (*moe.LeaveGroupResp, error) {
	if db == nil {
		return nil, gorm.ErrInvalidDB
	}
	groupID, err := parseGroupID(in.GetGroupId())
...
// DeleteGroup 删除群组。
func DeleteGroup(ctx context.Context, db *gorm.DB, in *moe.DeleteGroupReq) (*moe.DeleteGroupResp, error) {
	if db == nil {
		return nil, gorm.ErrInvalidDB
	}
	groupID, err := parseGroupID(in.GetGroupId())
...
// UpdateGroup 更新群组资料。
func UpdateGroup(ctx context.Context, db *gorm.DB, in *moe.UpdateGroupReq) (*moe.UpdateGroupResp, error) {
	if db == nil {
		return nil, gorm.ErrInvalidDB
	}
	groupID, err := parseGroupID(in.GetGroupId())
...
func CreateGroupPost(ctx context.Context, db *gorm.DB, in *moe.CreateGroupPostReq) (*moe.CreateGroupPostResp, error) {
	if db == nil {
		return nil, gorm.ErrInvalidDB
	}
	groupID, err := parseGroupID(in.GetGroupId())
...
func buildGroupPostResp(db *gorm.DB, link model.GroupPost, post model.Post, viewerUID uint) (*moe.CreateGroupPostResp, error) {
	var user model.User
