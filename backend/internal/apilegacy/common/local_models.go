...
func LoadLocalModelCatalog(conf config.LocalModelsConf) ([]LocalModelMeta, error) {
...
func resolveCatalogEntry(storageDir string, entry config.LocalModelCatalogEntry) (LocalModelMeta, error) {
...
func FindLocalModelByID(conf config.LocalModelsConf, id string) (LocalModelMeta, error) {
