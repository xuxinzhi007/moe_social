...
func MigrateModelRegistry() []MigrateEntry {
	return []MigrateEntry{
		...
		{Key: "battle_rooms", Model: &model.BattleRoom{}},
		{Key: "battle_scores", Model: &model.BattleScore{}},
		{Key: "battle_gift_events", Model: &model.BattleGiftEvent{}},
		{Key: "battle_idempotency_keys", Model: &model.BattleIdempotencyKey{}},
		...
		{Key: "arena_profiles", Model: &model.ArenaProfile{}},
