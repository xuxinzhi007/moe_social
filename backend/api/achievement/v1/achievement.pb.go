...
const file_api_achievement_v1_achievement_proto_rawDesc = "" +
	"\n" +
	"$api/achievement/v1/achievement.proto\x12\x0eachievement.v1\"\r\n" +
	"\vPingRequest\"\v\n" +
	"\tPingReply2P\n" +
	"\x0eAchievementApp\x12>\n" +
	"\x04Ping\x12\x1b.achievement.v1.PingRequest\x1a\x19.achievement.v1.PingReplyB*Z(backend/api/achievement/v1;achievementv1b\x06proto3"
...
var file_api_achievement_v1_achievement_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_achievement_v1_achievement_proto_goTypes = []any{
	(*PingRequest)(nil), // 0: achievement.v1.PingRequest
	(*PingReply)(nil),   // 1: achievement.v1.PingReply
}
var file_api_achievement_v1_achievement_proto_depIdxs = []int32{
	0, // 0: achievement.v1.AchievementApp.Ping:input_type -> achievement.v1.PingRequest
	1, // 1: achievement.v1.AchievementApp.Ping:output_type -> achievement.v1.PingReply
