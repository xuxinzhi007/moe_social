...
func RegisterAll(srv *khttp.Server, d PilotDeps) {
	...
	if d.Svc != nil {
		...
		RegisterPostCompat(srv, d.Svc)
		RegisterCommunityCompat(srv, d.Svc)
		RegisterUserCompat(srv, d.Svc)
		RegisterUserMemoryCompat(srv, d.Svc)
		RegisterAiCompat(srv, d.Svc)
		RegisterChatCompat(srv, d.Svc)
		RegisterWave2MiscCompat(srv, d.Svc)
		RegisterAdminServiceCompat(srv, d.Svc)
		RegisterAdminLegacyCompat(srv, d.Svc)
		RegisterPlatformCompat(srv, d.Svc)
