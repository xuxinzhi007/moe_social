...
type AdminAppClient interface {
	...
	AdminGetAppRelease(ctx context.Context, in *AdminGetAppReleaseReq, opts ...grpc.CallOption) (*AdminGetAppReleaseResp, error)
	AdminUpsertAppRelease(ctx context.Context, in *AdminUpsertAppReleaseReq, opts ...grpc.CallOption) (*AdminUpsertAppReleaseResp, error)
}
...
func (c *adminAppClient) AdminGetAppRelease(ctx context.Context, in *AdminGetAppReleaseReq, opts ...grpc.CallOption) (*AdminGetAppReleaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminGetAppReleaseResp)
	err := c.cc.Invoke(ctx, AdminApp_AdminGetAppRelease_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminAppClient) AdminUpsertAppRelease(ctx context.Context, in *AdminUpsertAppReleaseReq, opts ...grpc.CallOption) (*AdminUpsertAppReleaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminUpsertAppReleaseResp)
	err := c.cc.Invoke(ctx, AdminApp_AdminUpsertAppRelease_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminAppServer interface {
	...
	AdminUpsertAppRelease(context.Context, *AdminUpsertAppReleaseReq) (*AdminUpsertAppReleaseResp, error)
...
func (UnimplementedAdminAppServer) AdminGetAppRelease(context.Context, *AdminGetAppReleaseReq) (*AdminGetAppReleaseResp, error) {
	return nil, status.Error(codes.Unimplemented, "method AdminGetAppRelease not implemented")
}
func (UnimplementedAdminAppServer) AdminUpsertAppRelease(context.Context, *AdminUpsertAppReleaseReq) (*AdminUpsertAppReleaseResp, error) {
	return nil, status.Error(codes.Unimplemented, "method AdminUpsertAppRelease not implemented")
}
...
func _AdminApp_AdminGetAppRelease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminGetAppReleaseReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminAppServer).AdminGetAppRelease(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminApp_AdminGetAppRelease_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminAppServer).AdminGetAppRelease(ctx, req.(*AdminGetAppReleaseReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminApp_AdminUpsertAppRelease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminUpsertAppReleaseReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminAppServer).AdminUpsertAppRelease(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminApp_AdminUpsertAppRelease_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminAppServer).AdminUpsertAppRelease(ctx, req.(*AdminUpsertAppReleaseReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminApp_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdminGetAppRelease",
			Handler:    _AdminApp_AdminGetAppRelease_Handler,
		},
		{
			MethodName: "AdminUpsertAppRelease",
			Handler:    _AdminApp_AdminUpsertAppRelease_Handler,
		},
	},
