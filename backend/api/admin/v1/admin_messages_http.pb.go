...
const OperationAdminAppAdminListCheckInRewards = "/admin.v1.AdminApp/AdminListCheckInRewards"
...
const OperationAdminAppAdminUpdateCheckInReward = "/admin.v1.AdminApp/AdminUpdateCheckInReward"
...
const OperationAdminAppAdminUpsertAppRelease = "/admin.v1.AdminApp/AdminUpsertAppRelease"
...
func RegisterAdminAppHTTPServer(s *http.Server, srv AdminAppHTTPServer) {
	...
	r.GET("/api/admin/growth/check-in-rewards", _AdminApp_AdminListCheckInRewards0_HTTP_Handler(srv))
	r.PUT("/api/admin/growth/check-in-rewards/{reward_id}", _AdminApp_AdminUpdateCheckInReward0_HTTP_Handler(srv))
	...
	r.GET("/api/admin/app-release", _AdminApp_AdminGetAppRelease0_HTTP_Handler(srv))
	r.PUT("/api/admin/app-release", _AdminApp_AdminUpsertAppRelease0_HTTP_Handler(srv))
}
...
func _AdminApp_AdminListCheckInRewards0_HTTP_Handler(srv AdminAppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminListCheckInRewardsReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAdminAppAdminListCheckInRewards)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminListCheckInRewards(ctx, req.(*AdminListCheckInRewardsReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminListCheckInRewardsResp)
		return ctx.Result(200, reply)
	}
}

func _AdminApp_AdminUpdateCheckInReward0_HTTP_Handler(srv AdminAppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminUpdateCheckInRewardReq
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAdminAppAdminUpdateCheckInReward)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminUpdateCheckInReward(ctx, req.(*AdminUpdateCheckInRewardReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminUpdateCheckInRewardResp)
		return ctx.Result(200, reply)
	}
}
...
func _AdminApp_AdminGetAppRelease0_HTTP_Handler(srv AdminAppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminGetAppReleaseReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAdminAppAdminGetAppRelease)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminGetAppRelease(ctx, req.(*AdminGetAppReleaseReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminGetAppReleaseResp)
		return ctx.Result(200, reply)
	}
}

func _AdminApp_AdminUpsertAppRelease0_HTTP_Handler(srv AdminAppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminUpsertAppReleaseReq
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAdminAppAdminUpsertAppRelease)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminUpsertAppRelease(ctx, req.(*AdminUpsertAppReleaseReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminUpsertAppReleaseResp)
		return ctx.Result(200, reply)
	}
}
...
type AdminAppHTTPClient interface {
	...
	AdminListCheckInRewards(ctx context.Context, req *AdminListCheckInRewardsReq, opts ...http.CallOption) (rsp *AdminListCheckInRewardsResp, err error)
	...
	AdminUpdateCheckInReward(ctx context.Context, req *AdminUpdateCheckInRewardReq, opts ...http.CallOption) (rsp *AdminUpdateCheckInRewardResp, err error)
	...
	AdminUpsertAppRelease(ctx context.Context, req *AdminUpsertAppReleaseReq, opts ...http.CallOption) (rsp *AdminUpsertAppReleaseResp, err error)
...
func (c *AdminAppHTTPClientImpl) AdminGetAppRelease(ctx context.Context, in *AdminGetAppReleaseReq, opts ...http.CallOption) (*AdminGetAppReleaseResp, error) {
	var out AdminGetAppReleaseResp
	pattern := "/api/admin/app-release"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAdminAppAdminGetAppRelease))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AdminAppHTTPClientImpl) AdminListCheckInRewards(ctx context.Context, in *AdminListCheckInRewardsReq, opts ...http.CallOption) (*AdminListCheckInRewardsResp, error) {
	var out AdminListCheckInRewardsResp
	pattern := "/api/admin/growth/check-in-rewards"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAdminAppAdminListCheckInRewards))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AdminAppHTTPClientImpl) AdminUpdateCheckInReward(ctx context.Context, in *AdminUpdateCheckInRewardReq, opts ...http.CallOption) (*AdminUpdateCheckInRewardResp, error) {
	var out AdminUpdateCheckInRewardResp
	pattern := "/api/admin/growth/check-in-rewards/{reward_id}"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAdminAppAdminUpdateCheckInReward))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AdminAppHTTPClientImpl) AdminUpsertAppRelease(ctx context.Context, in *AdminUpsertAppReleaseReq, opts ...http.CallOption) (*AdminUpsertAppReleaseResp, error) {
	var out AdminUpsertAppReleaseResp
	pattern := "/api/admin/app-release"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAdminAppAdminUpsertAppRelease))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
		return nil, err
