...
var file_api_admin_v1_admin_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 247)
var file_api_admin_v1_admin_messages_proto_goTypes = []any{
	...
	(*AdminGetMemoryHealthReq)(nil),          // 82: admin.v1.AdminGetMemoryHealthReq
	(*AdminEmbeddingProbe)(nil),              // 83: admin.v1.AdminEmbeddingProbe
	(*AdminGetMemoryHealthResp)(nil),         // 84: admin.v1.AdminGetMemoryHealthResp
	(*AdminRebuildMemoryEmbeddingsReq)(nil),  // 85: admin.v1.AdminRebuildMemoryEmbeddingsReq
	(*AdminRebuildMemoryEmbeddingsResp)(nil), // 86: admin.v1.AdminRebuildMemoryEmbeddingsResp
	(*AdminExportLearningDatasetReq)(nil),    // 87: admin.v1.AdminExportLearningDatasetReq
	(*AdminExportLearningDatasetResp)(nil),   // 88: admin.v1.AdminExportLearningDatasetResp
	(*AdminGetMoeBrainPipelineReq)(nil),      // 89: admin.v1.AdminGetMoeBrainPipelineReq
	(*AdminGetMoeBrainPipelineResp)(nil),     // 90: admin.v1.AdminGetMoeBrainPipelineResp
	(*AdminGetMoeBrainReq)(nil),              // 91: admin.v1.AdminGetMoeBrainReq
	(*AdminGetMoeBrainResp)(nil),             // 92: admin.v1.AdminGetMoeBrainResp
	(*AdminGetMoeToolStatsReq)(nil),          // 93: admin.v1.AdminGetMoeToolStatsReq
	(*AdminGetMoeToolStatsResp)(nil),         // 94: admin.v1.AdminGetMoeToolStatsResp
	(*AdminGetSchemaCatalogReq)(nil),         // 95: admin.v1.AdminGetSchemaCatalogReq
	(*AdminGetSchemaCatalogResp)(nil),        // 96: admin.v1.AdminGetSchemaCatalogResp
	(*AdminGetUserProfileReq)(nil),           // 97: admin.v1.AdminGetUserProfileReq
	(*AdminGetUserProfileResp)(nil),          // 98: admin.v1.AdminGetUserProfileResp
	(*AdminGetUserReq)(nil),                  // 99: admin.v1.AdminGetUserReq
	(*AdminGetUserResp)(nil),                 // 100: admin.v1.AdminGetUserResp
	(*AdminGetVipPlanReq)(nil),               // 101: admin.v1.AdminGetVipPlanReq
	(*AdminGetVipPlanResp)(nil),              // 102: admin.v1.AdminGetVipPlanResp
	(*AdminGrowthStats)(nil),                 // 103: admin.v1.AdminGrowthStats
	(*AdminLevelConfigItem)(nil),             // 104: admin.v1.AdminLevelConfigItem
	(*AdminListAccountsReq)(nil),             // 105: admin.v1.AdminListAccountsReq
	(*AdminListAccountsResp)(nil),            // 106: admin.v1.AdminListAccountsResp
	(*AdminListAchievementsReq)(nil),         // 107: admin.v1.AdminListAchievementsReq
	(*AdminListAchievementsResp)(nil),        // 108: admin.v1.AdminListAchievementsResp
	(*AdminListAiAgentsReq)(nil),             // 109: admin.v1.AdminListAiAgentsReq
	(*AdminListAiAgentsResp)(nil),            // 110: admin.v1.AdminListAiAgentsResp
	(*AdminListAiChatMessagesReq)(nil),       // 111: admin.v1.AdminListAiChatMessagesReq
	(*AdminListAiChatMessagesResp)(nil),      // 112: admin.v1.AdminListAiChatMessagesResp
	(*AdminListAiChatSessionsReq)(nil),       // 113: admin.v1.AdminListAiChatSessionsReq
	(*AdminListAiChatSessionsResp)(nil),      // 114: admin.v1.AdminListAiChatSessionsResp
	(*AdminListAnnouncementsReq)(nil),        // 115: admin.v1.AdminListAnnouncementsReq
	(*AdminListAnnouncementsResp)(nil),       // 116: admin.v1.AdminListAnnouncementsResp
	(*AdminListAuditLogsReq)(nil),            // 117: admin.v1.AdminListAuditLogsReq
	(*AdminListAuditLogsResp)(nil),           // 118: admin.v1.AdminListAuditLogsResp
	(*AdminListCheckInRewardsReq)(nil),       // 119: admin.v1.AdminListCheckInRewardsReq
	(*AdminListCheckInRewardsResp)(nil),      // 120: admin.v1.AdminListCheckInRewardsResp
	(*AdminListCommentsReq)(nil),             // 121: admin.v1.AdminListCommentsReq
	(*AdminListCommentsResp)(nil),            // 122: admin.v1.AdminListCommentsResp
	(*AdminListFollowsReq)(nil),              // 123: admin.v1.AdminListFollowsReq
	(*AdminListFollowsResp)(nil),             // 124: admin.v1.AdminListFollowsResp
	(*AdminListFriendRequestsReq)(nil),       // 125: admin.v1.AdminListFriendRequestsReq
	(*AdminListFriendRequestsResp)(nil),      // 126: admin.v1.AdminListFriendRequestsResp
	(*AdminListGiftPurchaseOrdersReq)(nil),   // 127: admin.v1.AdminListGiftPurchaseOrdersReq
	(*AdminListGiftPurchaseOrdersResp)(nil),  // 128: admin.v1.AdminListGiftPurchaseOrdersResp
	(*AdminListGiftsReq)(nil),                // 129: admin.v1.AdminListGiftsReq
	(*AdminListGiftsResp)(nil),               // 130: admin.v1.AdminListGiftsResp
	(*AdminListGroupsReq)(nil),               // 131: admin.v1.AdminListGroupsReq
	(*AdminListGroupsResp)(nil),              // 132: admin.v1.AdminListGroupsResp
	(*AdminListLevelConfigsReq)(nil),         // 133: admin.v1.AdminListLevelConfigsReq
	(*AdminListLevelConfigsResp)(nil),        // 134: admin.v1.AdminListLevelConfigsResp
	(*AdminListMemoriesReq)(nil),             // 135: admin.v1.AdminListMemoriesReq
	(*AdminListMemoriesResp)(nil),            // 136: admin.v1.AdminListMemoriesResp
	(*AdminListMenusReq)(nil),                // 137: admin.v1.AdminListMenusReq
	(*AdminListMenusResp)(nil),               // 138: admin.v1.AdminListMenusResp
	(*AdminListMoeRuntimesReq)(nil),          // 139: admin.v1.AdminListMoeRuntimesReq
	(*AdminListMoeRuntimesResp)(nil),         // 140: admin.v1.AdminListMoeRuntimesResp
	(*AdminListMoeToolCallsReq)(nil),         // 141: admin.v1.AdminListMoeToolCallsReq
	(*AdminListMoeToolCallsResp)(nil),        // 142: admin.v1.AdminListMoeToolCallsResp
	(*AdminListPostReportsReq)(nil),          // 143: admin.v1.AdminListPostReportsReq
	(*AdminListPostReportsResp)(nil),         // 144: admin.v1.AdminListPostReportsResp
	(*AdminListPostsReq)(nil),                // 145: admin.v1.AdminListPostsReq
	(*AdminListPostsResp)(nil),               // 146: admin.v1.AdminListPostsResp
	(*AdminListTagDictionaryReq)(nil),        // 147: admin.v1.AdminListTagDictionaryReq
	(*AdminListTagDictionaryResp)(nil),       // 148: admin.v1.AdminListTagDictionaryResp
	(*AdminListTopicTagsReq)(nil),            // 149: admin.v1.AdminListTopicTagsReq
	(*AdminListTopicTagsResp)(nil),           // 150: admin.v1.AdminListTopicTagsResp
	(*AdminListUsersReq)(nil),                // 151: admin.v1.AdminListUsersReq
	(*AdminListUsersResp)(nil),               // 152: admin.v1.AdminListUsersResp
	(*AdminListVipOrdersReq)(nil),            // 153: admin.v1.AdminListVipOrdersReq
	(*AdminListVipOrdersResp)(nil),           // 154: admin.v1.AdminListVipOrdersResp
	(*AdminListVipPlansReq)(nil),             // 155: admin.v1.AdminListVipPlansReq
	(*AdminListVipPlansResp)(nil),            // 156: admin.v1.AdminListVipPlansResp
	(*AdminLoginReq)(nil),                    // 157: admin.v1.AdminLoginReq
	(*AdminLoginResp)(nil),                   // 158: admin.v1.AdminLoginResp
	(*AdminMemoryItem)(nil),                  // 159: admin.v1.AdminMemoryItem
	(*AdminMemoryStats)(nil),                 // 160: admin.v1.AdminMemoryStats
	(*AdminMemoryTypeStat)(nil),              // 161: admin.v1.AdminMemoryTypeStat
	(*AdminMenuItem)(nil),                    // 162: admin.v1.AdminMenuItem
	(*AdminMoeToolCallItem)(nil),             // 163: admin.v1.AdminMoeToolCallItem
	(*AdminMoeToolDayStat)(nil),              // 164: admin.v1.AdminMoeToolDayStat
	(*AdminMoeToolStatRow)(nil),              // 165: admin.v1.AdminMoeToolStatRow
	(*AdminPostReportItem)(nil),              // 166: admin.v1.AdminPostReportItem
	(*AdminPublishAnnouncementReq)(nil),      // 167: admin.v1.AdminPublishAnnouncementReq
	(*AdminPublishAnnouncementResp)(nil),     // 168: admin.v1.AdminPublishAnnouncementResp
	(*AdminRefineMoeBrainEpisodeReq)(nil),    // 169: admin.v1.AdminRefineMoeBrainEpisodeReq
	(*AdminRefineMoeBrainEpisodeResp)(nil),   // 170: admin.v1.AdminRefineMoeBrainEpisodeResp
	(*AdminRunMoeAgentOnceReq)(nil),          // 171: admin.v1.AdminRunMoeAgentOnceReq
	(*AdminRunMoeAgentOnceResp)(nil),         // 172: admin.v1.AdminRunMoeAgentOnceResp
	(*AdminSchemaCatalogSummary)(nil),        // 173: admin.v1.AdminSchemaCatalogSummary
	(*AdminSchemaTableItem)(nil),             // 174: admin.v1.AdminSchemaTableItem
	(*AdminSendNotificationReq)(nil),         // 175: admin.v1.AdminSendNotificationReq
	(*AdminSendNotificationResp)(nil),        // 176: admin.v1.AdminSendNotificationResp
	(*AdminTagDictionaryItem)(nil),           // 177: admin.v1.AdminTagDictionaryItem
	(*AdminUpdateAccountReq)(nil),            // 178: admin.v1.AdminUpdateAccountReq
	(*AdminUpdateAccountResp)(nil),           // 179: admin.v1.AdminUpdateAccountResp
	(*AdminUpdateAchievementReq)(nil),        // 180: admin.v1.AdminUpdateAchievementReq
	(*AdminUpdateAchievementResp)(nil),       // 181: admin.v1.AdminUpdateAchievementResp
	(*AdminUpdateAnnouncementReq)(nil),       // 182: admin.v1.AdminUpdateAnnouncementReq
	(*AdminUpdateAnnouncementResp)(nil),      // 183: admin.v1.AdminUpdateAnnouncementResp
	(*AdminUpdateCheckInRewardReq)(nil),      // 184: admin.v1.AdminUpdateCheckInRewardReq
	(*AdminUpdateCheckInRewardResp)(nil),     // 185: admin.v1.AdminUpdateCheckInRewardResp
	(*AdminUpdateGiftReq)(nil),               // 186: admin.v1.AdminUpdateGiftReq
	(*AdminUpdateGiftResp)(nil),              // 187: admin.v1.AdminUpdateGiftResp
	(*AdminUpdateLevelConfigReq)(nil),        // 188: admin.v1.AdminUpdateLevelConfigReq
	(*AdminUpdateLevelConfigResp)(nil),       // 189: admin.v1.AdminUpdateLevelConfigResp
	(*AdminUpdateMoeBrainPolicyReq)(nil),     // 190: admin.v1.AdminUpdateMoeBrainPolicyReq
	(*AdminUpdateTagDictionaryReq)(nil),      // 191: admin.v1.AdminUpdateTagDictionaryReq
	(*AdminUpdateTagDictionaryResp)(nil),     // 192: admin.v1.AdminUpdateTagDictionaryResp
	(*AdminUpdateTopicTagReq)(nil),           // 193: admin.v1.AdminUpdateTopicTagReq
	(*AdminUpdateTopicTagResp)(nil),          // 194: admin.v1.AdminUpdateTopicTagResp
	(*AdminUpdateUserReq)(nil),               // 195: admin.v1.AdminUpdateUserReq
	(*AdminUpdateUserResp)(nil),              // 196: admin.v1.AdminUpdateUserResp
	(*AdminUpdateVipPlanReq)(nil),            // 197: admin.v1.AdminUpdateVipPlanReq
	(*AdminUpdateVipPlanResp)(nil),           // 198: admin.v1.AdminUpdateVipPlanResp
	(*AdminUpsertMenuReq)(nil),               // 199: admin.v1.AdminUpsertMenuReq
	(*AdminUpsertMenuResp)(nil),              // 200: admin.v1.AdminUpsertMenuResp
	(*AdminUpsertMoeRuntimeReq)(nil),         // 201: admin.v1.AdminUpsertMoeRuntimeReq
	(*AdminUpsertMoeRuntimeResp)(nil),        // 202: admin.v1.AdminUpsertMoeRuntimeResp
	(*AdminUserBehaviorScreenStat)(nil),      // 203: admin.v1.AdminUserBehaviorScreenStat
	(*AdminUserBehaviorSummary)(nil),         // 204: admin.v1.AdminUserBehaviorSummary
	(*AdminUserLevelSnapshot)(nil),           // 205: admin.v1.AdminUserLevelSnapshot
	(*AdminUserProfileData)(nil),             // 206: admin.v1.AdminUserProfileData
	(*AdminUserRelationCounts)(nil),          // 207: admin.v1.AdminUserRelationCounts
	(*AdminUserRelationLink)(nil),            // 208: admin.v1.AdminUserRelationLink
	(*Comment)(nil),                          // 209: admin.v1.Comment
	(*Gift)(nil),                             // 210: admin.v1.Gift
	(*GiftPurchaseOrder)(nil),                // 211: admin.v1.GiftPurchaseOrder
	(*Group)(nil),                            // 212: admin.v1.Group
	(*MoeAgentRuntimeItem)(nil),              // 213: admin.v1.MoeAgentRuntimeItem
	(*MoeBrainEpisodeItem)(nil),              // 214: admin.v1.MoeBrainEpisodeItem
	(*MoeBrainGenerationMeta)(nil),           // 215: admin.v1.MoeBrainGenerationMeta
	(*MoeBrainMemoryItem)(nil),               // 216: admin.v1.MoeBrainMemoryItem
	(*MoeBrainTagStat)(nil),                  // 217: admin.v1.MoeBrainTagStat
	(*MoeGenAttemptItem)(nil),                // 218: admin.v1.MoeGenAttemptItem
	(*MoeHostMetrics)(nil),                   // 219: admin.v1.MoeHostMetrics
	(*MoePipelineStepItem)(nil),              // 220: admin.v1.MoePipelineStepItem
	(*Post)(nil),                             // 221: admin.v1.Post
	(*RecordAdminAuditLogReq)(nil),           // 222: admin.v1.RecordAdminAuditLogReq
	(*RecordAdminAuditLogResp)(nil),          // 223: admin.v1.RecordAdminAuditLogResp
	(*TopicTag)(nil),                         // 224: admin.v1.TopicTag
	(*User)(nil),                             // 225: admin.v1.User
	(*VipOrder)(nil),                         // 226: admin.v1.VipOrder
	(*VipPlan)(nil),                          // 227: admin.v1.VipPlan
	(*AdminMeReq)(nil),                       // 228: admin.v1.AdminMeReq
	(*AdminMeResp)(nil),                      // 229: admin.v1.AdminMeResp
	(*AdminUpdateAiAgentReq)(nil),            // 230: admin.v1.AdminUpdateAiAgentReq
	(*AdminUpdateAiAgentResp)(nil),           // 231: admin.v1.AdminUpdateAiAgentResp
	(*AdminMediaImageItem)(nil),              // 232: admin.v1.AdminMediaImageItem
	(*AdminMediaOwnerSummary)(nil),           // 233: admin.v1.AdminMediaOwnerSummary
	(*AdminListMediaImagesReq)(nil),          // 234: admin.v1.AdminListMediaImagesReq
	(*AdminListMediaImagesResp)(nil),         // 235: admin.v1.AdminListMediaImagesResp
	(*AdminDeleteMediaImageReq)(nil),         // 236: admin.v1.AdminDeleteMediaImageReq
	(*AdminDeleteMediaImageResp)(nil),        // 237: admin.v1.AdminDeleteMediaImageResp
	(*AdminGetRuntimeConfigReq)(nil),         // 238: admin.v1.AdminGetRuntimeConfigReq
	(*AdminGetRuntimeConfigResp)(nil),        // 239: admin.v1.AdminGetRuntimeConfigResp
	(*AdminUpdateRuntimeConfigReq)(nil),      // 240: admin.v1.AdminUpdateRuntimeConfigReq
	(*AdminUpdateRuntimeConfigResp)(nil),     // 241: admin.v1.AdminUpdateRuntimeConfigResp
	(*AdminRuntimeProcessInfo)(nil),          // 242: admin.v1.AdminRuntimeProcessInfo
	(*AdminGetRuntimeOverviewReq)(nil),       // 243: admin.v1.AdminGetRuntimeOverviewReq
	(*AdminGetRuntimeOverviewResp)(nil),      // 244: admin.v1.AdminGetRuntimeOverviewResp
	(*PingRequest)(nil),                      // 245: admin.v1.PingRequest
	(*PingReply)(nil),                        // 246: admin.v1.PingReply
}
var file_api_admin_v1_admin_messages_proto_depIdxs = []int32{
	...
	161, // 2: admin.v1.AdminAnalyticsOverviewResp.memory_by_type:type_name -> admin.v1.AdminMemoryTypeStat
	...
	210, // 7: admin.v1.AdminCreateGiftResp.gift:type_name -> admin.v1.Gift
	177, // 8: admin.v1.AdminCreateTagDictionaryResp.item:type_name -> admin.v1.AdminTagDictionaryItem
	224, // 9: admin.v1.AdminCreateTopicTagResp.item:type_name -> admin.v1.TopicTag
	170, // 10: admin.v1.AdminCurateMoeBrainResp.results:type_name -> admin.v1.AdminRefineMoeBrainEpisodeResp
	6,   // 11: admin.v1.AdminGetAnnouncementResp.announcement:type_name -> admin.v1.AdminAnnouncementItem
	210, // 12: admin.v1.AdminGetGiftResp.gift:type_name -> admin.v1.Gift
	103, // 13: admin.v1.AdminGetGrowthStatsResp.stats:type_name -> admin.v1.AdminGrowthStats
	160, // 14: admin.v1.AdminGetMemoryStatsResp.stats:type_name -> admin.v1.AdminMemoryStats
	160, // 15: admin.v1.AdminGetMemoryHealthResp.stats:type_name -> admin.v1.AdminMemoryStats
	83,  // 16: admin.v1.AdminGetMemoryHealthResp.embedding_probe:type_name -> admin.v1.AdminEmbeddingProbe
	220, // 17: admin.v1.AdminGetMoeBrainPipelineResp.steps:type_name -> admin.v1.MoePipelineStepItem
	219, // 18: admin.v1.AdminGetMoeBrainPipelineResp.host_metrics:type_name -> admin.v1.MoeHostMetrics
	218, // 19: admin.v1.AdminGetMoeBrainPipelineResp.generate_attempts:type_name -> admin.v1.MoeGenAttemptItem
	217, // 20: admin.v1.AdminGetMoeBrainResp.tag_stats:type_name -> admin.v1.MoeBrainTagStat
	214, // 21: admin.v1.AdminGetMoeBrainResp.episodes:type_name -> admin.v1.MoeBrainEpisodeItem
	216, // 22: admin.v1.AdminGetMoeBrainResp.memories:type_name -> admin.v1.MoeBrainMemoryItem
	215, // 23: admin.v1.AdminGetMoeBrainResp.generation_meta:type_name -> admin.v1.MoeBrainGenerationMeta
	165, // 24: admin.v1.AdminGetMoeToolStatsResp.by_tool:type_name -> admin.v1.AdminMoeToolStatRow
	164, // 25: admin.v1.AdminGetMoeToolStatsResp.by_day:type_name -> admin.v1.AdminMoeToolDayStat
	173, // 26: admin.v1.AdminGetSchemaCatalogResp.summary:type_name -> admin.v1.AdminSchemaCatalogSummary
	174, // 27: admin.v1.AdminGetSchemaCatalogResp.items:type_name -> admin.v1.AdminSchemaTableItem
	206, // 28: admin.v1.AdminGetUserProfileResp.data:type_name -> admin.v1.AdminUserProfileData
	225, // 29: admin.v1.AdminGetUserResp.user:type_name -> admin.v1.User
	227, // 30: admin.v1.AdminGetVipPlanResp.plan:type_name -> admin.v1.VipPlan
	0,   // 31: admin.v1.AdminListAccountsResp.items:type_name -> admin.v1.AdminAccountItem
	1,   // 32: admin.v1.AdminListAchievementsResp.items:type_name -> admin.v1.AdminAchievementItem
	2,   // 33: admin.v1.AdminListAiAgentsResp.items:type_name -> admin.v1.AdminAiAgentItem
	3,   // 34: admin.v1.AdminListAiChatMessagesResp.items:type_name -> admin.v1.AdminAiChatMessageItem
	4,   // 35: admin.v1.AdminListAiChatSessionsResp.items:type_name -> admin.v1.AdminAiChatSessionItem
	6,   // 36: admin.v1.AdminListAnnouncementsResp.items:type_name -> admin.v1.AdminAnnouncementItem
	7,   // 37: admin.v1.AdminListAuditLogsResp.items:type_name -> admin.v1.AdminAuditLogItem
	24,  // 38: admin.v1.AdminListCheckInRewardsResp.items:type_name -> admin.v1.AdminCheckInRewardItem
	209, // 39: admin.v1.AdminListCommentsResp.comments:type_name -> admin.v1.Comment
	72,  // 40: admin.v1.AdminListFollowsResp.items:type_name -> admin.v1.AdminFollowItem
	73,  // 41: admin.v1.AdminListFriendRequestsResp.items:type_name -> admin.v1.AdminFriendRequestItem
	211, // 42: admin.v1.AdminListGiftPurchaseOrdersResp.orders:type_name -> admin.v1.GiftPurchaseOrder
	210, // 43: admin.v1.AdminListGiftsResp.gifts:type_name -> admin.v1.Gift
	212, // 44: admin.v1.AdminListGroupsResp.groups:type_name -> admin.v1.Group
	104, // 45: admin.v1.AdminListLevelConfigsResp.items:type_name -> admin.v1.AdminLevelConfigItem
	159, // 46: admin.v1.AdminListMemoriesResp.items:type_name -> admin.v1.AdminMemoryItem
	162, // 47: admin.v1.AdminListMenusResp.items:type_name -> admin.v1.AdminMenuItem
	213, // 48: admin.v1.AdminListMoeRuntimesResp.items:type_name -> admin.v1.MoeAgentRuntimeItem
	163, // 49: admin.v1.AdminListMoeToolCallsResp.items:type_name -> admin.v1.AdminMoeToolCallItem
	166, // 50: admin.v1.AdminListPostReportsResp.reports:type_name -> admin.v1.AdminPostReportItem
	221, // 51: admin.v1.AdminListPostsResp.posts:type_name -> admin.v1.Post
	177, // 52: admin.v1.AdminListTagDictionaryResp.items:type_name -> admin.v1.AdminTagDictionaryItem
	224, // 53: admin.v1.AdminListTopicTagsResp.items:type_name -> admin.v1.TopicTag
	225, // 54: admin.v1.AdminListUsersResp.users:type_name -> admin.v1.User
	226, // 55: admin.v1.AdminListVipOrdersResp.orders:type_name -> admin.v1.VipOrder
	227, // 56: admin.v1.AdminListVipPlansResp.plans:type_name -> admin.v1.VipPlan
	161, // 57: admin.v1.AdminMemoryStats.by_type:type_name -> admin.v1.AdminMemoryTypeStat
	6,   // 58: admin.v1.AdminPublishAnnouncementResp.announcement:type_name -> admin.v1.AdminAnnouncementItem
	0,   // 59: admin.v1.AdminUpdateAccountResp.account:type_name -> admin.v1.AdminAccountItem
	1,   // 60: admin.v1.AdminUpdateAchievementResp.item:type_name -> admin.v1.AdminAchievementItem
	6,   // 61: admin.v1.AdminUpdateAnnouncementResp.announcement:type_name -> admin.v1.AdminAnnouncementItem
	24,  // 62: admin.v1.AdminUpdateCheckInRewardResp.item:type_name -> admin.v1.AdminCheckInRewardItem
	210, // 63: admin.v1.AdminUpdateGiftResp.gift:type_name -> admin.v1.Gift
	104, // 64: admin.v1.AdminUpdateLevelConfigResp.item:type_name -> admin.v1.AdminLevelConfigItem
	177, // 65: admin.v1.AdminUpdateTagDictionaryResp.item:type_name -> admin.v1.AdminTagDictionaryItem
	224, // 66: admin.v1.AdminUpdateTopicTagResp.item:type_name -> admin.v1.TopicTag
	225, // 67: admin.v1.AdminUpdateUserResp.user:type_name -> admin.v1.User
	227, // 68: admin.v1.AdminUpdateVipPlanResp.plan:type_name -> admin.v1.VipPlan
	162, // 69: admin.v1.AdminUpsertMenuResp.menu:type_name -> admin.v1.AdminMenuItem
	213, // 70: admin.v1.AdminUpsertMoeRuntimeResp.item:type_name -> admin.v1.MoeAgentRuntimeItem
	203, // 71: admin.v1.AdminUserBehaviorSummary.top_screens:type_name -> admin.v1.AdminUserBehaviorScreenStat
	225, // 72: admin.v1.AdminUserProfileData.user:type_name -> admin.v1.User
	207, // 73: admin.v1.AdminUserProfileData.counts:type_name -> admin.v1.AdminUserRelationCounts
	205, // 74: admin.v1.AdminUserProfileData.level:type_name -> admin.v1.AdminUserLevelSnapshot
	208, // 75: admin.v1.AdminUserProfileData.links:type_name -> admin.v1.AdminUserRelationLink
	204, // 76: admin.v1.AdminUserProfileData.behavior:type_name -> admin.v1.AdminUserBehaviorSummary
	224, // 77: admin.v1.Post.topic_tags:type_name -> admin.v1.TopicTag
	232, // 78: admin.v1.AdminListMediaImagesResp.items:type_name -> admin.v1.AdminMediaImageItem
	233, // 79: admin.v1.AdminListMediaImagesResp.owners:type_name -> admin.v1.AdminMediaOwnerSummary
	242, // 80: admin.v1.AdminGetRuntimeOverviewResp.api_process:type_name -> admin.v1.AdminRuntimeProcessInfo
	242, // 81: admin.v1.AdminGetRuntimeOverviewResp.rpc_process:type_name -> admin.v1.AdminRuntimeProcessInfo
	245, // 82: admin.v1.AdminApp.Ping:input_type -> admin.v1.PingRequest
	8,   // 83: admin.v1.AdminApp.AdminBootstrapAccount:input_type -> admin.v1.AdminBootstrapAccountReq
	157, // 84: admin.v1.AdminApp.AdminLogin:input_type -> admin.v1.AdminLoginReq
	105, // 85: admin.v1.AdminApp.AdminListAccounts:input_type -> admin.v1.AdminListAccountsReq
	25,  // 86: admin.v1.AdminApp.AdminCreateAccount:input_type -> admin.v1.AdminCreateAccountReq
	178, // 87: admin.v1.AdminApp.AdminUpdateAccount:input_type -> admin.v1.AdminUpdateAccountReq
	42,  // 88: admin.v1.AdminApp.AdminDeleteAccount:input_type -> admin.v1.AdminDeleteAccountReq
	10,  // 89: admin.v1.AdminApp.AdminBootstrapAchievements:input_type -> admin.v1.AdminBootstrapAchievementsReq
	109, // 90: admin.v1.AdminApp.AdminListAiAgents:input_type -> admin.v1.AdminListAiAgentsReq
	44,  // 91: admin.v1.AdminApp.AdminDeleteAiAgent:input_type -> admin.v1.AdminDeleteAiAgentReq
	115, // 92: admin.v1.AdminApp.AdminListAnnouncements:input_type -> admin.v1.AdminListAnnouncementsReq
	27,  // 93: admin.v1.AdminApp.AdminCreateAnnouncement:input_type -> admin.v1.AdminCreateAnnouncementReq
	74,  // 94: admin.v1.AdminApp.AdminGetAnnouncement:input_type -> admin.v1.AdminGetAnnouncementReq
	182, // 95: admin.v1.AdminApp.AdminUpdateAnnouncement:input_type -> admin.v1.AdminUpdateAnnouncementReq
	46,  // 96: admin.v1.AdminApp.AdminDeleteAnnouncement:input_type -> admin.v1.AdminDeleteAnnouncementReq
	167, // 97: admin.v1.AdminApp.AdminPublishAnnouncement:input_type -> admin.v1.AdminPublishAnnouncementReq
	117, // 98: admin.v1.AdminApp.AdminListAuditLogs:input_type -> admin.v1.AdminListAuditLogsReq
	121, // 99: admin.v1.AdminApp.AdminListComments:input_type -> admin.v1.AdminListCommentsReq
	48,  // 100: admin.v1.AdminApp.AdminDeleteComment:input_type -> admin.v1.AdminDeleteCommentReq
	131, // 101: admin.v1.AdminApp.AdminListGroups:input_type -> admin.v1.AdminListGroupsReq
	54,  // 102: admin.v1.AdminApp.AdminDeleteGroup:input_type -> admin.v1.AdminDeleteGroupReq
	129, // 103: admin.v1.AdminApp.AdminListGifts:input_type -> admin.v1.AdminListGiftsReq
	29,  // 104: admin.v1.AdminApp.AdminCreateGift:input_type -> admin.v1.AdminCreateGiftReq
	76,  // 105: admin.v1.AdminApp.AdminGetGift:input_type -> admin.v1.AdminGetGiftReq
	186, // 106: admin.v1.AdminApp.AdminUpdateGift:input_type -> admin.v1.AdminUpdateGiftReq
	52,  // 107: admin.v1.AdminApp.AdminDeleteGift:input_type -> admin.v1.AdminDeleteGiftReq
	12,  // 108: admin.v1.AdminApp.AdminBootstrapGifts:input_type -> admin.v1.AdminBootstrapGiftsReq
	40,  // 109: admin.v1.AdminApp.AdminDedupeGifts:input_type -> admin.v1.AdminDedupeGiftsReq
	107, // 110: admin.v1.AdminApp.AdminListAchievements:input_type -> admin.v1.AdminListAchievementsReq
	180, // 111: admin.v1.AdminApp.AdminUpdateAchievement:input_type -> admin.v1.AdminUpdateAchievementReq
	133, // 112: admin.v1.AdminApp.AdminListLevelConfigs:input_type -> admin.v1.AdminListLevelConfigsReq
	188, // 113: admin.v1.AdminApp.AdminUpdateLevelConfig:input_type -> admin.v1.AdminUpdateLevelConfigReq
	14,  // 114: admin.v1.AdminApp.AdminBootstrapLevels:input_type -> admin.v1.AdminBootstrapLevelsReq
	119, // 115: admin.v1.AdminApp.AdminListCheckInRewards:input_type -> admin.v1.AdminListCheckInRewardsReq
	184, // 116: admin.v1.AdminApp.AdminUpdateCheckInReward:input_type -> admin.v1.AdminUpdateCheckInRewardReq
	22,  // 117: admin.v1.AdminApp.AdminBroadcastNotification:input_type -> admin.v1.AdminBroadcastNotificationReq
	175, // 118: admin.v1.AdminApp.AdminSendNotification:input_type -> admin.v1.AdminSendNotificationReq
	127, // 119: admin.v1.AdminApp.AdminListGiftPurchaseOrders:input_type -> admin.v1.AdminListGiftPurchaseOrdersReq
	153, // 120: admin.v1.AdminApp.AdminListVipOrders:input_type -> admin.v1.AdminListVipOrdersReq
	143, // 121: admin.v1.AdminApp.AdminListPostReports:input_type -> admin.v1.AdminListPostReportsReq
	145, // 122: admin.v1.AdminApp.AdminListPosts:input_type -> admin.v1.AdminListPostsReq
	62,  // 123: admin.v1.AdminApp.AdminDeletePost:input_type -> admin.v1.AdminDeletePostReq
	123, // 124: admin.v1.AdminApp.AdminListFollows:input_type -> admin.v1.AdminListFollowsReq
	50,  // 125: admin.v1.AdminApp.AdminDeleteFollow:input_type -> admin.v1.AdminDeleteFollowReq
	125, // 126: admin.v1.AdminApp.AdminListFriendRequests:input_type -> admin.v1.AdminListFriendRequestsReq
	147, // 127: admin.v1.AdminApp.AdminListTagDictionary:input_type -> admin.v1.AdminListTagDictionaryReq
	31,  // 128: admin.v1.AdminApp.AdminCreateTagDictionary:input_type -> admin.v1.AdminCreateTagDictionaryReq
	191, // 129: admin.v1.AdminApp.AdminUpdateTagDictionary:input_type -> admin.v1.AdminUpdateTagDictionaryReq
	64,  // 130: admin.v1.AdminApp.AdminDeleteTagDictionary:input_type -> admin.v1.AdminDeleteTagDictionaryReq
	193, // 131: admin.v1.AdminApp.AdminUpdateTopicTag:input_type -> admin.v1.AdminUpdateTopicTagReq
	66,  // 132: admin.v1.AdminApp.AdminDeleteTopicTag:input_type -> admin.v1.AdminDeleteTopicTagReq
	18,  // 133: admin.v1.AdminApp.AdminBootstrapTopicTags:input_type -> admin.v1.AdminBootstrapTopicTagsReq
	151, // 134: admin.v1.AdminApp.AdminListUsers:input_type -> admin.v1.AdminListUsersReq
	99,  // 135: admin.v1.AdminApp.AdminGetUser:input_type -> admin.v1.AdminGetUserReq
	195, // 136: admin.v1.AdminApp.AdminUpdateUser:input_type -> admin.v1.AdminUpdateUserReq
	97,  // 137: admin.v1.AdminApp.AdminGetUserProfile:input_type -> admin.v1.AdminGetUserProfileReq
	101, // 138: admin.v1.AdminApp.AdminGetVipPlan:input_type -> admin.v1.AdminGetVipPlanReq
	197, // 139: admin.v1.AdminApp.AdminUpdateVipPlan:input_type -> admin.v1.AdminUpdateVipPlanReq
	68,  // 140: admin.v1.AdminApp.AdminDeleteVipPlan:input_type -> admin.v1.AdminDeleteVipPlanReq
	20,  // 141: admin.v1.AdminApp.AdminBootstrapVipPlans:input_type -> admin.v1.AdminBootstrapVipPlansReq
	230, // 142: admin.v1.AdminApp.AdminUpdateAiAgent:input_type -> admin.v1.AdminUpdateAiAgentReq
	228, // 143: admin.v1.AdminApp.AdminMe:input_type -> admin.v1.AdminMeReq
	234, // 144: admin.v1.AdminApp.AdminListMediaImages:input_type -> admin.v1.AdminListMediaImagesReq
	236, // 145: admin.v1.AdminApp.AdminDeleteMediaImage:input_type -> admin.v1.AdminDeleteMediaImageReq
	135, // 146: admin.v1.AdminApp.AdminListMemories:input_type -> admin.v1.AdminListMemoriesReq
	56,  // 147: admin.v1.AdminApp.AdminDeleteMemory:input_type -> admin.v1.AdminDeleteMemoryReq
	80,  // 148: admin.v1.AdminApp.AdminGetMemoryStats:input_type -> admin.v1.AdminGetMemoryStatsReq
	82,  // 149: admin.v1.AdminApp.AdminGetMemoryHealth:input_type -> admin.v1.AdminGetMemoryHealthReq
	85,  // 150: admin.v1.AdminApp.AdminRebuildMemoryEmbeddings:input_type -> admin.v1.AdminRebuildMemoryEmbeddingsReq
	87,  // 151: admin.v1.AdminApp.AdminExportLearningDataset:input_type -> admin.v1.AdminExportLearningDatasetReq
	137, // 152: admin.v1.AdminApp.AdminListMenus:input_type -> admin.v1.AdminListMenusReq
	199, // 153: admin.v1.AdminApp.AdminUpsertMenu:input_type -> admin.v1.AdminUpsertMenuReq
	58,  // 154: admin.v1.AdminApp.AdminDeleteMenu:input_type -> admin.v1.AdminDeleteMenuReq
	16,  // 155: admin.v1.AdminApp.AdminBootstrapMenus:input_type -> admin.v1.AdminBootstrapMenusReq
	238, // 156: admin.v1.AdminApp.AdminGetRuntimeConfig:input_type -> admin.v1.AdminGetRuntimeConfigReq
	240, // 157: admin.v1.AdminApp.AdminUpdateRuntimeConfig:input_type -> admin.v1.AdminUpdateRuntimeConfigReq
	243, // 158: admin.v1.AdminApp.AdminRuntimeOverview:input_type -> admin.v1.AdminGetRuntimeOverviewReq
	113, // 159: admin.v1.AdminInsights.AdminListAiChatSessions:input_type -> admin.v1.AdminListAiChatSessionsReq
	111, // 160: admin.v1.AdminInsights.AdminListAiChatMessages:input_type -> admin.v1.AdminListAiChatMessagesReq
	70,  // 161: admin.v1.AdminInsights.AdminExportAiChatMessages:input_type -> admin.v1.AdminExportAiChatMessagesReq
	80,  // 162: admin.v1.AdminInsights.AdminAnalyticsOverview:input_type -> admin.v1.AdminGetMemoryStatsReq
	149, // 163: admin.v1.AdminInsights.AdminListTopicTags:input_type -> admin.v1.AdminListTopicTagsReq
	37,  // 164: admin.v1.AdminInsights.AdminDashboard:input_type -> admin.v1.AdminDashboardReq
	78,  // 165: admin.v1.AdminInsights.AdminGrowthStats:input_type -> admin.v1.AdminGetGrowthStatsReq
	95,  // 166: admin.v1.AdminInsights.AdminSchemaCatalog:input_type -> admin.v1.AdminGetSchemaCatalogReq
	246, // 167: admin.v1.AdminApp.Ping:output_type -> admin.v1.PingReply
	9,   // 168: admin.v1.AdminApp.AdminBootstrapAccount:output_type -> admin.v1.AdminBootstrapAccountResp
	158, // 169: admin.v1.AdminApp.AdminLogin:output_type -> admin.v1.AdminLoginResp
	106, // 170: admin.v1.AdminApp.AdminListAccounts:output_type -> admin.v1.AdminListAccountsResp
	26,  // 171: admin.v1.AdminApp.AdminCreateAccount:output_type -> admin.v1.AdminCreateAccountResp
	179, // 172: admin.v1.AdminApp.AdminUpdateAccount:output_type -> admin.v1.AdminUpdateAccountResp
	43,  // 173: admin.v1.AdminApp.AdminDeleteAccount:output_type -> admin.v1.AdminDeleteAccountResp
	11,  // 174: admin.v1.AdminApp.AdminBootstrapAchievements:output_type -> admin.v1.AdminBootstrapAchievementsResp
	110, // 175: admin.v1.AdminApp.AdminListAiAgents:output_type -> admin.v1.AdminListAiAgentsResp
	45,  // 176: admin.v1.AdminApp.AdminDeleteAiAgent:output_type -> admin.v1.AdminDeleteAiAgentResp
	116, // 177: admin.v1.AdminApp.AdminListAnnouncements:output_type -> admin.v1.AdminListAnnouncementsResp
	28,  // 178: admin.v1.AdminApp.AdminCreateAnnouncement:output_type -> admin.v1.AdminCreateAnnouncementResp
	75,  // 179: admin.v1.AdminApp.AdminGetAnnouncement:output_type -> admin.v1.AdminGetAnnouncementResp
	183, // 180: admin.v1.AdminApp.AdminUpdateAnnouncement:output_type -> admin.v1.AdminUpdateAnnouncementResp
	47,  // 181: admin.v1.AdminApp.AdminDeleteAnnouncement:output_type -> admin.v1.AdminDeleteAnnouncementResp
	168, // 182: admin.v1.AdminApp.AdminPublishAnnouncement:output_type -> admin.v1.AdminPublishAnnouncementResp
	118, // 183: admin.v1.AdminApp.AdminListAuditLogs:output_type -> admin.v1.AdminListAuditLogsResp
	122, // 184: admin.v1.AdminApp.AdminListComments:output_type -> admin.v1.AdminListCommentsResp
	49,  // 185: admin.v1.AdminApp.AdminDeleteComment:output_type -> admin.v1.AdminDeleteCommentResp
	132, // 186: admin.v1.AdminApp.AdminListGroups:output_type -> admin.v1.AdminListGroupsResp
	55,  // 187: admin.v1.AdminApp.AdminDeleteGroup:output_type -> admin.v1.AdminDeleteGroupResp
	130, // 188: admin.v1.AdminApp.AdminListGifts:output_type -> admin.v1.AdminListGiftsResp
	30,  // 189: admin.v1.AdminApp.AdminCreateGift:output_type -> admin.v1.AdminCreateGiftResp
	77,  // 190: admin.v1.AdminApp.AdminGetGift:output_type -> admin.v1.AdminGetGiftResp
	187, // 191: admin.v1.AdminApp.AdminUpdateGift:output_type -> admin.v1.AdminUpdateGiftResp
	53,  // 192: admin.v1.AdminApp.AdminDeleteGift:output_type -> admin.v1.AdminDeleteGiftResp
	13,  // 193: admin.v1.AdminApp.AdminBootstrapGifts:output_type -> admin.v1.AdminBootstrapGiftsResp
	41,  // 194: admin.v1.AdminApp.AdminDedupeGifts:output_type -> admin.v1.AdminDedupeGiftsResp
	108, // 195: admin.v1.AdminApp.AdminListAchievements:output_type -> admin.v1.AdminListAchievementsResp
	181, // 196: admin.v1.AdminApp.AdminUpdateAchievement:output_type -> admin.v1.AdminUpdateAchievementResp
	134, // 197: admin.v1.AdminApp.AdminListLevelConfigs:output_type -> admin.v1.AdminListLevelConfigsResp
	189, // 198: admin.v1.AdminApp.AdminUpdateLevelConfig:output_type -> admin.v1.AdminUpdateLevelConfigResp
	15,  // 199: admin.v1.AdminApp.AdminBootstrapLevels:output_type -> admin.v1.AdminBootstrapLevelsResp
	120, // 200: admin.v1.AdminApp.AdminListCheckInRewards:output_type -> admin.v1.AdminListCheckInRewardsResp
	185, // 201: admin.v1.AdminApp.AdminUpdateCheckInReward:output_type -> admin.v1.AdminUpdateCheckInRewardResp
	23,  // 202: admin.v1.AdminApp.AdminBroadcastNotification:output_type -> admin.v1.AdminBroadcastNotificationResp
	176, // 203: admin.v1.AdminApp.AdminSendNotification:output_type -> admin.v1.AdminSendNotificationResp
	128, // 204: admin.v1.AdminApp.AdminListGiftPurchaseOrders:output_type -> admin.v1.AdminListGiftPurchaseOrdersResp
	154, // 205: admin.v1.AdminApp.AdminListVipOrders:output_type -> admin.v1.AdminListVipOrdersResp
	144, // 206: admin.v1.AdminApp.AdminListPostReports:output_type -> admin.v1.AdminListPostReportsResp
	146, // 207: admin.v1.AdminApp.AdminListPosts:output_type -> admin.v1.AdminListPostsResp
	63,  // 208: admin.v1.AdminApp.AdminDeletePost:output_type -> admin.v1.AdminDeletePostResp
	124, // 209: admin.v1.AdminApp.AdminListFollows:output_type -> admin.v1.AdminListFollowsResp
	51,  // 210: admin.v1.AdminApp.AdminDeleteFollow:output_type -> admin.v1.AdminDeleteFollowResp
	126, // 211: admin.v1.AdminApp.AdminListFriendRequests:output_type -> admin.v1.AdminListFriendRequestsResp
	148, // 212: admin.v1.AdminApp.AdminListTagDictionary:output_type -> admin.v1.AdminListTagDictionaryResp
	32,  // 213: admin.v1.AdminApp.AdminCreateTagDictionary:output_type -> admin.v1.AdminCreateTagDictionaryResp
	192, // 214: admin.v1.AdminApp.AdminUpdateTagDictionary:output_type -> admin.v1.AdminUpdateTagDictionaryResp
	65,  // 215: admin.v1.AdminApp.AdminDeleteTagDictionary:output_type -> admin.v1.AdminDeleteTagDictionaryResp
	194, // 216: admin.v1.AdminApp.AdminUpdateTopicTag:output_type -> admin.v1.AdminUpdateTopicTagResp
	67,  // 217: admin.v1.AdminApp.AdminDeleteTopicTag:output_type -> admin.v1.AdminDeleteTopicTagResp
	19,  // 218: admin.v1.AdminApp.AdminBootstrapTopicTags:output_type -> admin.v1.AdminBootstrapTopicTagsResp
	152, // 219: admin.v1.AdminApp.AdminListUsers:output_type -> admin.v1.AdminListUsersResp
	100, // 220: admin.v1.AdminApp.AdminGetUser:output_type -> admin.v1.AdminGetUserResp
	196, // 221: admin.v1.AdminApp.AdminUpdateUser:output_type -> admin.v1.AdminUpdateUserResp
	98,  // 222: admin.v1.AdminApp.AdminGetUserProfile:output_type -> admin.v1.AdminGetUserProfileResp
	102, // 223: admin.v1.AdminApp.AdminGetVipPlan:output_type -> admin.v1.AdminGetVipPlanResp
	198, // 224: admin.v1.AdminApp.AdminUpdateVipPlan:output_type -> admin.v1.AdminUpdateVipPlanResp
	69,  // 225: admin.v1.AdminApp.AdminDeleteVipPlan:output_type -> admin.v1.AdminDeleteVipPlanResp
	21,  // 226: admin.v1.AdminApp.AdminBootstrapVipPlans:output_type -> admin.v1.AdminBootstrapVipPlansResp
	231, // 227: admin.v1.AdminApp.AdminUpdateAiAgent:output_type -> admin.v1.AdminUpdateAiAgentResp
	229, // 228: admin.v1.AdminApp.AdminMe:output_type -> admin.v1.AdminMeResp
	235, // 229: admin.v1.AdminApp.AdminListMediaImages:output_type -> admin.v1.AdminListMediaImagesResp
	237, // 230: admin.v1.AdminApp.AdminDeleteMediaImage:output_type -> admin.v1.AdminDeleteMediaImageResp
	136, // 231: admin.v1.AdminApp.AdminListMemories:output_type -> admin.v1.AdminListMemoriesResp
	57,  // 232: admin.v1.AdminApp.AdminDeleteMemory:output_type -> admin.v1.AdminDeleteMemoryResp
	81,  // 233: admin.v1.AdminApp.AdminGetMemoryStats:output_type -> admin.v1.AdminGetMemoryStatsResp
	84,  // 234: admin.v1.AdminApp.AdminGetMemoryHealth:output_type -> admin.v1.AdminGetMemoryHealthResp
	86,  // 235: admin.v1.AdminApp.AdminRebuildMemoryEmbeddings:output_type -> admin.v1.AdminRebuildMemoryEmbeddingsResp
	88,  // 236: admin.v1.AdminApp.AdminExportLearningDataset:output_type -> admin.v1.AdminExportLearningDatasetResp
	138, // 237: admin.v1.AdminApp.AdminListMenus:output_type -> admin.v1.AdminListMenusResp
	200, // 238: admin.v1.AdminApp.AdminUpsertMenu:output_type -> admin.v1.AdminUpsertMenuResp
	59,  // 239: admin.v1.AdminApp.AdminDeleteMenu:output_type -> admin.v1.AdminDeleteMenuResp
	17,  // 240: admin.v1.AdminApp.AdminBootstrapMenus:output_type -> admin.v1.AdminBootstrapMenusResp
	239, // 241: admin.v1.AdminApp.AdminGetRuntimeConfig:output_type -> admin.v1.AdminGetRuntimeConfigResp
	241, // 242: admin.v1.AdminApp.AdminUpdateRuntimeConfig:output_type -> admin.v1.AdminUpdateRuntimeConfigResp
	244, // 243: admin.v1.AdminApp.AdminRuntimeOverview:output_type -> admin.v1.AdminGetRuntimeOverviewResp
	114, // 244: admin.v1.AdminInsights.AdminListAiChatSessions:output_type -> admin.v1.AdminListAiChatSessionsResp
	112, // 245: admin.v1.AdminInsights.AdminListAiChatMessages:output_type -> admin.v1.AdminListAiChatMessagesResp
	71,  // 246: admin.v1.AdminInsights.AdminExportAiChatMessages:output_type -> admin.v1.AdminExportAiChatMessagesResp
	5,   // 247: admin.v1.AdminInsights.AdminAnalyticsOverview:output_type -> admin.v1.AdminAnalyticsOverviewResp
	150, // 248: admin.v1.AdminInsights.AdminListTopicTags:output_type -> admin.v1.AdminListTopicTagsResp
	38,  // 249: admin.v1.AdminInsights.AdminDashboard:output_type -> admin.v1.AdminDashboardResp
	79,  // 250: admin.v1.AdminInsights.AdminGrowthStats:output_type -> admin.v1.AdminGetGrowthStatsResp
	96,  // 251: admin.v1.AdminInsights.AdminSchemaCatalog:output_type -> admin.v1.AdminGetSchemaCatalogResp
	167, // [167:252] is the sub-list for method output_type
	82,  // [82:167] is the sub-list for method input_type
