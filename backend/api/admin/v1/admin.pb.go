...
const file_api_admin_v1_admin_proto_rawDesc = "" +
	...
	"\tPingReply2>\n" +
	"\bAdminApp\x122\n" +
	"\x04Ping\x12\x15.admin.v1.PingRequest\x1a\x13.admin.v1.PingReplyB\x1eZ\x1cbackend/api/admin/v1;adminv1b\x06proto3"
...
var file_api_admin_v1_admin_proto_goTypes = []any{
	(*PingRequest)(nil), // 0: admin.v1.PingRequest
	(*PingReply)(nil),   // 1: admin.v1.PingReply
}
var file_api_admin_v1_admin_proto_depIdxs = []int32{
	0, // 0: admin.v1.AdminApp.Ping:input_type -> admin.v1.PingRequest
	1, // 1: admin.v1.AdminApp.Ping:output_type -> admin.v1.PingReply
