...
type Comment struct {
	...
	AuthorIsBot       bool                   `protobuf:"varint,12,opt,name=author_is_bot,json=authorIsBot,proto3" json:"author_is_bot,omitempty"`
	AuthorBotAgentKey string                 `protobuf:"bytes,13,opt,name=author_bot_agent_key,json=authorBotAgentKey,proto3" json:"author_bot_agent_key,omitempty"`
...
func (x *Comment) GetAuthorIsBot() bool {
	if x != nil {
...
func (x *Comment) GetAuthorBotAgentKey() string {
	if x != nil {
...
const file_api_comment_v1_comment_proto_rawDesc = "" +
	...
	"comment.v1\x1a\x1cgoogle/api/annotations.proto\"\x92\x03\n" +
	"\aComment\x12\x0e\n" +
	...
	"\tparent_id\x18\n" +
	" \x01(\tR\bparentId\x12+\n" +
	"\x12reply_to_user_name\x18\v \x01(\tR\x0freplyToUserName\x12\"\n" +
	"\rauthor_is_bot\x18\f \x01(\bR\vauthorIsBot\x12/\n" +
	"\x14author_bot_agent_key\x18\r \x01(\tR\x11authorBotAgentKey\"\x9b\x01\n" +
	...
	"\acomment\x18\x01 \x01(\v2\x13.comment.v1.CommentR\acomment2\xf6\x02\n" +
	"\x0eCommentService\x12~\n" +
	"\x0fGetPostComments\x12\".comment.v1.GetPostCommentsRequest\x1a .comment.v1.GetPostCommentsReply\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/api/posts/{post_id}/comments\x12k\n" +
	"\rCreateComment\x12 .comment.v1.CreateCommentRequest\x1a\x1e.comment.v1.CreateCommentReply\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/api/comments\x12w\n" +
	"\vLikeComment\x12\x1e.comment.v1.LikeCommentRequest\x1a\x1c.comment.v1.LikeCommentReply\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/api/comments/{comment_id}/likeB\"Z backend/api/comment/v1;commentv1b\x06proto3"
