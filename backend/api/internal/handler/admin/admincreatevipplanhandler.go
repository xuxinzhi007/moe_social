...
func AdminCreateVipPlanHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if _, br := common.RequireAdminToken(r); br != nil {
			httpx.OkJsonCtx(r.Context(), w, &types.AdminCreateVipPlanResp{BaseResp: *br})
			return
		}
		...
		l := admin.NewAdminCreateVipPlanLogic(r.Context(), svcCtx)
		resp, err := l.AdminCreateVipPlan(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
