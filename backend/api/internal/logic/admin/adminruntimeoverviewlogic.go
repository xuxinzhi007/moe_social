...
type AdminRuntimeOverviewLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewAdminRuntimeOverviewLogic(ctx context.Context, svcCtx *svc.ServiceContext) *AdminRuntimeOverviewLogic {
	return &AdminRuntimeOverviewLogic{Logger: logx.WithContext(ctx), ctx: ctx, svcCtx: svcCtx}
}

func (l *AdminRuntimeOverviewLogic) AdminRuntimeOverview(_ *types.EmptyReq) (*types.AdminRuntimeOverviewResp, error) {
	...
	if live, ok := fetchRPCDebugLive(l.ctx); ok {
