...
type AdminBootstrapTopicTagsData struct {
	Created int `json:"created"`
}

type AdminBootstrapTopicTagsResp struct {
	BaseResp
	Data AdminBootstrapTopicTagsData `json:"data"`
}
...
type AdminDedupeGiftsData struct {
	Removed int `json:"removed"`
}

type AdminDedupeGiftsResp struct {
	BaseResp
	Data AdminDedupeGiftsData `json:"data"`
}
...
type AdminDeleteMoeBotFlowReq struct {
	AgentKey string `path:"agent_key"`
}

type AdminDeleteMoeBotFlowResp struct {
	BaseResp
	Data AdminGetMoeBotFlowData `json:"data"`
}
...
type AdminGetMoeBotFlowData struct {
	...
	Nodes        []MoeFlowNodeItem `json:"nodes"`
	Edges        []MoeFlowEdgeItem `json:"edges"`
	ViewportZoom float64           `json:"viewport_zoom,optional"`
...
type AdminGetMoeBotFlowReq struct {
	AgentKey string `path:"agent_key"`
}

type AdminGetMoeBotFlowResp struct {
	BaseResp
	Data AdminGetMoeBotFlowData `json:"data"`
}
...
type AdminGetMoeBrainData struct {
	...
	AvgEpisodeQuality int                    `json:"avg_episode_quality,optional"`
}
...
type AdminGetMoeBrainPipelineData struct {
	...
	ToolsInvoked     []MoePipelineToolInvokeItem `json:"tools_invoked,optional"`
	StabilityScore   int                         `json:"stability_score,optional"`
	StabilityDelta   int                         `json:"stability_delta,optional"`
...
type AdminUpsertMoeBotFlowReq struct {
	AgentKey     string            `path:"agent_key"`
	Nodes        []MoeFlowNodeItem `json:"nodes"`
	Edges        []MoeFlowEdgeItem `json:"edges"`
	ViewportZoom float64           `json:"viewport_zoom,optional"`
...
type AdminUpsertMoeBotFlowResp struct {
	BaseResp
	Data AdminGetMoeBotFlowData `json:"data"`
}
...
type MoeFlowNodeItem struct {
	Id        string  `json:"id"`
	Type      string  `json:"type"`
	Kind      string  `json:"kind,optional"`
	Label     string  `json:"label"`
	Subtitle  string  `json:"subtitle,optional"`
	StepKey   string  `json:"step_key,optional"`
	ToolName  string  `json:"tool_name,optional"`
	PositionX float64 `json:"position_x"`
	PositionY float64 `json:"position_y"`
	Enabled   bool    `json:"enabled,optional"`
	OnFail    string  `json:"on_fail,optional"`
	RetryMax  int     `json:"retry_max,optional"`
}
...
type MoePipelineToolInvokeItem struct {
	Tool      string `json:"tool"`
	Ok        bool   `json:"ok"`
