...
const (
	...
	UserService_GenerateTempEmail_FullMethodName          = "/user.v1.UserService/GenerateTempEmail"
	UserService_GetTempEmailLatestCode_FullMethodName     = "/user.v1.UserService/GetTempEmailLatestCode"
...
type UserServiceClient interface {
	...
	GenerateTempEmail(ctx context.Context, in *GenerateTempEmailReq, opts ...grpc.CallOption) (*GenerateTempEmailResp, error)
	GetTempEmailLatestCode(ctx context.Context, in *GetTempEmailLatestCodeReq, opts ...grpc.CallOption) (*GetTempEmailLatestCodeResp, error)
...
func (c *userServiceClient) GenerateTempEmail(ctx context.Context, in *GenerateTempEmailReq, opts ...grpc.CallOption) (*GenerateTempEmailResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateTempEmailResp)
	err := c.cc.Invoke(ctx, UserService_GenerateTempEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetTempEmailLatestCode(ctx context.Context, in *GetTempEmailLatestCodeReq, opts ...grpc.CallOption) (*GetTempEmailLatestCodeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTempEmailLatestCodeResp)
	err := c.cc.Invoke(ctx, UserService_GetTempEmailLatestCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) GenerateTempEmail(context.Context, *GenerateTempEmailReq) (*GenerateTempEmailResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateTempEmail not implemented")
}
func (UnimplementedUserServiceServer) GetTempEmailLatestCode(context.Context, *GetTempEmailLatestCodeReq) (*GetTempEmailLatestCodeResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTempEmailLatestCode not implemented")
}
...
func _UserService_GenerateTempEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateTempEmailReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GenerateTempEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GenerateTempEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GenerateTempEmail(ctx, req.(*GenerateTempEmailReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_GetTempEmailLatestCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTempEmailLatestCodeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetTempEmailLatestCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetTempEmailLatestCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetTempEmailLatestCode(ctx, req.(*GetTempEmailLatestCodeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GenerateTempEmail",
			Handler:    _UserService_GenerateTempEmail_Handler,
		},
		{
			MethodName: "GetTempEmailLatestCode",
			Handler:    _UserService_GetTempEmailLatestCode_Handler,
		},
		{
