...
const file_api_user_v1_user_proto_rawDesc = "" +
	...
	"\tPingReply2;\n" +
	"\aUserApp\x120\n" +
	"\x04Ping\x12\x14.user.v1.PingRequest\x1a\x12.user.v1.PingReplyB\x1cZ\x1abackend/api/user/v1;userv1b\x06proto3"
...
var file_api_user_v1_user_proto_goTypes = []any{
	...
	(*PingReply)(nil),   // 1: user.v1.PingReply
}
var file_api_user_v1_user_proto_depIdxs = []int32{
	0, // 0: user.v1.UserApp.Ping:input_type -> user.v1.PingRequest
	1, // 1: user.v1.UserApp.Ping:output_type -> user.v1.PingReply
