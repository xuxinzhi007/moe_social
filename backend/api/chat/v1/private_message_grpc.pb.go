...
func (c *privateMessageServiceClient) SendPrivateMessage(ctx context.Context, in *SendPrivateMessageReq, opts ...grpc.CallOption) (*SendPrivateMessageResp, error) {
...
func (c *privateMessageServiceClient) ListPrivateMessages(ctx context.Context, in *ListPrivateMessagesReq, opts ...grpc.CallOption) (*ListPrivateMessagesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *privateMessageServiceClient) ListPrivateConversations(ctx context.Context, in *ListPrivateConversationsReq, opts ...grpc.CallOption) (*ListPrivateConversationsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedPrivateMessageServiceServer) SendPrivateMessage(context.Context, *SendPrivateMessageReq) (*SendPrivateMessageResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SendPrivateMessage not implemented")
}
func (UnimplementedPrivateMessageServiceServer) ListPrivateMessages(context.Context, *ListPrivateMessagesReq) (*ListPrivateMessagesResp, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPrivateMessages not implemented")
}
func (UnimplementedPrivateMessageServiceServer) ListPrivateConversations(context.Context, *ListPrivateConversationsReq) (*ListPrivateConversationsResp, error) {
...
func _PrivateMessageService_SendPrivateMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateMessageServiceServer).SendPrivateMessage(ctx, req.(*SendPrivateMessageReq))
	}
...
func _PrivateMessageService_ListPrivateMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateMessageServiceServer).ListPrivateMessages(ctx, req.(*ListPrivateMessagesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PrivateMessageService_ListPrivateConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateMessageServiceServer).ListPrivateConversations(ctx, req.(*ListPrivateConversationsReq))
	}
	return interceptor(ctx, in, info, handler)
}
