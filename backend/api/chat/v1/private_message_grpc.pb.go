...
const (
	...
	PrivateMessageService_ClearPrivateChatHistory_FullMethodName  = "/chat.v1.PrivateMessageService/ClearPrivateChatHistory"
)
...
type PrivateMessageServiceClient interface {
	...
	ClearPrivateChatHistory(ctx context.Context, in *ClearPrivateChatHistoryReq, opts ...grpc.CallOption) (*ClearPrivateChatHistoryResp, error)
}
...
func (c *privateMessageServiceClient) ClearPrivateChatHistory(ctx context.Context, in *ClearPrivateChatHistoryReq, opts ...grpc.CallOption) (*ClearPrivateChatHistoryResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ClearPrivateChatHistoryResp)
	err := c.cc.Invoke(ctx, PrivateMessageService_ClearPrivateChatHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PrivateMessageServiceServer interface {
	...
	ClearPrivateChatHistory(context.Context, *ClearPrivateChatHistoryReq) (*ClearPrivateChatHistoryResp, error)
...
func (UnimplementedPrivateMessageServiceServer) ClearPrivateChatHistory(context.Context, *ClearPrivateChatHistoryReq) (*ClearPrivateChatHistoryResp, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearPrivateChatHistory not implemented")
}
...
func _PrivateMessageService_ClearPrivateChatHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearPrivateChatHistoryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PrivateMessageServiceServer).ClearPrivateChatHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PrivateMessageService_ClearPrivateChatHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateMessageServiceServer).ClearPrivateChatHistory(ctx, req.(*ClearPrivateChatHistoryReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PrivateMessageService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ClearPrivateChatHistory",
			Handler:    _PrivateMessageService_ClearPrivateChatHistory_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/chat/v1/private_message.proto",
