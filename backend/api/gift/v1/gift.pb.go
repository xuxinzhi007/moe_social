...
const file_api_gift_v1_gift_proto_rawDesc = "" +
	"\n" +
	"\x16api/gift/v1/gift.proto\x12\agift.v1\"\r\n" +
	"\vPingRequest\"\v\n" +
	"\tPingReply2;\n" +
	"\aGiftApp\x120\n" +
	"\x04Ping\x12\x14.gift.v1.PingRequest\x1a\x12.gift.v1.PingReplyB\x1cZ\x1abackend/api/gift/v1;giftv1b\x06proto3"
...
var file_api_gift_v1_gift_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_gift_v1_gift_proto_goTypes = []any{
	(*PingRequest)(nil), // 0: gift.v1.PingRequest
	(*PingReply)(nil),   // 1: gift.v1.PingReply
}
var file_api_gift_v1_gift_proto_depIdxs = []int32{
	0, // 0: gift.v1.GiftApp.Ping:input_type -> gift.v1.PingRequest
	1, // 1: gift.v1.GiftApp.Ping:output_type -> gift.v1.PingReply
