...
| **Kratos 后端（当前）** | [dev/kratos-migration-status.md](./dev/kratos-migration-status.md)（**当前/下一步**） · [dev/kratos-legacy-api-migration.md](./dev/kratos-legacy-api-migration.md) · [dev/new-api-kratos.md](./dev/new-api-kratos.md) |
