...
6. **Kratos**：**必读** `docs/dev/kratos-migration.md`。**生产**：`make moe-social` / `make build-moe-social` → **对外 :8888**。**纯 Kratos 方案 100%**：`make verify-kratos-100`；试点 `make moe-kratos`（:1903x，非对外）。
