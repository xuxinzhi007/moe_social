...
Keep this file short. If a topic needs detail, put it in a dedicated file and link it here. For this repo, review rules live in `code_review.md`; architecture details belong in `backend/README.md` and `docs/README.md`.
