...
func dashboardSnapshot() gin.H {
	...
	return gin.H{
		...
		"endpoints": []ginH{
			...
			{"method": "GET", "path": "/workspace/view?path=...", "transport": "http", "description": "Serve workspace HTML with click tracking"},
			{"method": "POST", "path": "/api/page-events/click", "transport": "http", "description": "Receive browser click telemetry"},
			{"method": "GET", "path": "/api/page-events", "transport": "http", "description": "Recent browser click events"},
		},
